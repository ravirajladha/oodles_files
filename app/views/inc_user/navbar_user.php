		...
		<div class="main-bar">
			<div class="container">
				<div class="header-content">
					...
					<img src="<?php echo URLROOT; ?>/assets_retail/mecwin_white.png" alt="" width="100">
...
<div class="sidebar">
		<div class="author-box">
			...
			<div class="dz-info">
				...
				<?php
			$pageMod = new Page;
			$user_detail = $pageMod->get_user_info($_SESSION['rexkod_user_phone']);
			?>
			<h5 class="name"> <?php echo "$user_detail->employee_name" ?></h2>
			</h5>
			</div>
		</div>
		<ul class="nav navbar-nav">	
			<!-- <li class="nav-label">No Data</li> -->
			<!-- Commented IIN -->
			...
			<li><a class="nav-link" href="<?php echo URLROOT?>/user/payslip">
		...
		<!--	<li><a class="nav-link" href="pages.html">
			...
			-->
			<li><a class="nav-link" href="<?php echo URLROOT?>/user/logout">
				<span class="dz-icon bg-red light">
					<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
						<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							<rect x="0" y="0" width="24" height="24"/>
