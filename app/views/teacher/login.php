			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form" style="margin-top:50px">
						...
						<form method="post" action="<?php echo URLROOT; ?>/teacher/login" autocomplete="off" class="register-form">

							<p style="text-align:center;font-size:24px;">Teacher Login</p>
							<br>
							...
							<div class="form-group form-button">
								...
								<a href="<?php echo URLROOT; ?>/teacher/forgot_password" class="signup-image-link btn btn-warning" style="background-color:#F99300;display:inline;">Forgot Password</a>
								<!-- <a href="<?php echo URLROOT; ?>/teacher/register" class="signup-image-link btn btn-danger" style="background-color:#F99300;display:block;">Sign Up</a> -->
							</div>
							<div class="form-group ">
