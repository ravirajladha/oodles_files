						...
						<div class="row">
							<?php if ($data['category'] != 1) { ?>
								...
								<div class="col-lg-12 col-sm-6">
									<a href="<?php echo URLROOT ?>/teacher/quiz_library/1/0">
							...
							<?php if ($data['category'] != 3) { ?>
								...
								<div class="col-lg-12 col-sm-6">
									<a href="<?php echo URLROOT ?>/teacher/quiz_library/3/0">
							...
							<?php if ($data['category'] != 4) { ?>
								...
								<!-- <div class="col-lg-4 col-sm-6">
									<a href="<?php echo URLROOT ?>/teacher/quiz_library/4/0">
								...
								<div class="card-box">
									...
									<div class="card-body  row">
										...
										?>
											...
											<div class="col-lg-2">
												<a href="<?php echo URLROOT ?>/teacher/quiz_library/<?php echo $data['category'] ?>/<?php echo $get_subject_detail->id; ?>">
													<!-- Contact Chip -->
