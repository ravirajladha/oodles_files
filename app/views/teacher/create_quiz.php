						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="form-control" placeholder="Enter Quiz Name" name="quiz_name" id="title">
								</div>
							</div>
						</div>
					</div>
		...
		<div class="row">
			<div class=" col-sm-12">
				<div class="card-box">
					...
					<form method="POST" action="<?php echo URLROOT; ?>/teacher/add_quiz" enctype="multipart/form-data" autocomplete="OFF">
