...
<head>
	...
	<meta name="description" content="Forgot Password Teacher OodlesIn" />
	<meta name="author" content="OodlesIn" />
	<title>OodlesIn - Forgot Password Teacher</title>
	<!-- google font -->
			...
			<div class="container">
				<div class="signin-content">
					<div class="signin-image">
						...
						<a href="<?php echo URLROOT?>/teacher/login" class="signup-image-link">Login here</a>
					</div>
					<div class="signin-form">
						<h2 class="form-title">Forgot Password?</h2>
						<p>Enter your phone number bellow to receive otp for reset password</p>
						<p>Our system checks whether the user is a 'Teacher' and his mobile number exists or not, else the user will not get the otp.</p>
            <br>
            <form method="post" action="<?php echo URLROOT;?>/teacher/update_password" autocomplete="off" class="register-form" >
...
// alert (phone);
		$.ajax({
							url  : '<?php echo URLROOT; ?>/teacher/check_phone_live_and_school',
							type : 'POST',
							data : {phn},
