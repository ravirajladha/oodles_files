										...
										<div class="blogThumb" style="height:480px;">
											...
											<?php	}
												?> 
													...
													<div class="col-md-12 col-sm-12"> -->
													<a href="<?php echO URLROOT?>/teacher/quiz_result_student_wise/<?php echo $quiz->id;?>" class="btn blue-bgcolor btn-outline btn-circle m-b-10" style="width:100%;">View Result</a>
										...
										<div class="blogThumb" style="height:480px;">
											...
											<?php	}
												?> 
													...
													<div class="col-md-12 col-sm-12"> -->
													<a href="<?php echO URLROOT?>/teacher/view_result_student_wise/<?php echo $quiz->id;?>" class="btn blue-bgcolor btn-outline btn-circle m-b-10" style="width:100%;">View Result</a>
