...
foreach ($data['get_all_subject'] as $all_subject) {
	$get_student_result = $teacherMod->get_single_student_subjectwise_result($data['student_id'], $all_subject->id);
	$store_percentage = 0;
	$total_per = 0;
	...
	$cur = array("label" => $all_subject->subject_name, "y" => $total_per);
