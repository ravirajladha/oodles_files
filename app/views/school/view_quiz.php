				...
				<div class="col-md-12">
					...
					<div class="profile-sidebar">
						...
						<div class="row">
										...
										<?php if($quiz_detail->status==0){ ?>
										<div class="col-md-12" style="width:100%;"><a href="<?php echo URLROOT?>/school/update_quiz_status/<?php echo $quiz_detail->id;?>/1">
											<button type="button" class="btn btn-warning btn-lg m-b-10" style="width:100%;">Approve 
												</button>
		</a>
										</div>
<?php }else{ ?>
	<div class="col-md-12" style="width:100%;"><a href="<?php echo URLROOT?>/school/update_quiz_status/<?php echo $quiz_detail->id;?>/0">
											<button type="button" class="btn btn-success btn-lg m-b-10" style="width:100%;">Dis-Approve 
												</button>
		</a>
										</div>
<?php } ?>
