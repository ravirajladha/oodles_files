                                ...
                                <?php foreach ($data['get_quiz_score'] as $quiz_score) { ?>
                                    <tr>
                                        ...
                                        <td class="left"><?php
                                                            ...
                                                            if (empty($quiz_score->coins_earned)) {
                                                                echo "0";
                                                            } else {
                                        ...
                                        <td class="left" style=<?php if ($quiz_score->pass == 0) { ?>color:#FF0000; <?php } else { ?> color:#1e921e; <?php     } ?>><?php echo round($quiz_score->score_per, 2) ?>%</td>
