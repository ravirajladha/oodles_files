						...
						<div class="row">
							<?php if ($data['category'] != 1) { ?>
								...
								<div class="col-lg-12 col-sm-6">
									<a href="<?php echo URLROOT ?>/school/quizes/1/0">
							...
							<?php if ($data['category'] != 2) { ?>
								...
								<!-- <div class="col-lg-4 col-sm-6">
									<a href="<?php echo URLROOT ?>/school/quizes/2/0">
							...
							<?php if ($data['category'] != 3) { ?>
								...
								<div class="col-lg-12 col-sm-6">
									<a href="<?php echo URLROOT ?>/school/quizes/3/0">
							...
							<?php if ($data['category'] != 4) { ?>
								...
								<!-- <div class="col-lg-4 col-sm-6">
									<a href="<?php echo URLROOT ?>/school/quizes/4/0">
					...
					<div class="row">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Admin</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								...
								<div class="card-box">
									...
									<div class="card-body  row">
										...
										?>
											...
											<div class="col-lg-2">
												<a href="<?php echo URLROOT ?>/school/quizes/<?php echo $data['category'] ?>/<?php echo $get_subject_detail->id; ?>">
													<!-- Contact Chip -->
							...
							<div class="row">
								<?php foreach ($data['get_all_quiz'] as $quiz) { ?>
									...
									<div class="col-lg-3 col-md-6 col-12 col-sm-6">
										<div class="blogThumb" style="height:460px;">
											<div class="thumb-center"><img class="img-responsive" alt="user" src="<?php echo URLROOT; ?>/uploads/<?php echo $quiz->image ?>" style="height:150px;width:100%;"></div>
											<div class="white-box" style="padding:3px;">
												...
												<div class="text-muted"><span class="m-r-10" style="color:black;font-size:12px;">
													...
													<div class="col-md-12 col-sm-12"> -->
														<a href="<?php echo URLROOT ?>/school/view_quiz/<?php echo $quiz->id; ?>" class="btn blue-bgcolor btn-outline btn-circle m-b-10" style="width:100%;">Read More</a>
												...
												?>
												<p style="font-size:10px;">Created_by: <?php echo $get_teacher_detail->name; ?>
												<?php
