														...
														<table class="table table-inbox table-hover mytable">
															<tbody>
																<tr class="unread">
																	...
																	<td class="view-message ">Created By</a></td>
																...
																<!-- <td class="inbox-small-cells">
																	...
																	<td class="view-message "><?php echo $quiz->id?></td>
																	...
																	<td class="view-message "><?php echo $quiz->created_by?></td>
																<td>  <a href="<?php echo URLROOT; ?>/school/delete_from_quiz_master/<?php echo $quiz->id;?>"><button class="btn btn-danger m-r-10" type="button">Delete</button></a></td>
