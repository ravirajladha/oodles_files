...
<div class="container mt-3 mb-4 text-center">
            <h4 class="text">Solar Pumps</h4>
        </div>
       
        <div class="row">
        <div class="col-xs-6"><br><br>
            <img src="<?php echo URLROOT; ?>/assets_retail/solor1.png" alt="">
        </div>

        <div class="col-xs-6"><br><br>
            <img src="<?php echo URLROOT; ?>/assets_retail/solor2.png" style="padding-bottom:10px" alt="">
        </div>
 
        <div class="col-xs-6"><br><br>
            <img src="<?php echo URLROOT; ?>/assets_retail/solor3.png" style="padding-bottom:10px"alt="">
        </div>
 

        <div class="col-xs-6"><br><br>
            <img src="<?php echo URLROOT; ?>/assets_retail/solor4.png" alt="">
        </div>    
        </div><br><br>
<?php if(isset($_SESSION['rexkod_user_id'])){ ?>
        <center><a href="<?php echo URLROOT?>/retail/solar_pump_enquiry"><button class="btn btn-success btn-md">Enquire</button></a></center>
<?php }?>
    </main>
