...
<?php require APPROOT . '/views/inc_retail/navbar.php'; ?>
 ...
 <div class="banner-wrapper author-notification">
     <div class="container inner-wrapper">
         <div class="dz-info">
             <span>Welcome</span>
             <h2 class="name mb-0"><?php echo $_SESSION['rexkod_user_name']; ?></h2>
         </div>
         ...
         <div class="dashboard-area">
                ...
                <div class="features-box">
                        <div class="row m-b20 g-3">
                            ...
                            <a href="<?php echo URLROOT?>/retail/new_order">
                 ...
                 <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                     <div class="modal-content">
                         ...
                         <div class="modal-body">
                             <form action='<?php echo URLROOT; ?>/retail/apply_leaves' method='POST'>
                                 <div class="row">
                                     <div class="col-sm-12">
