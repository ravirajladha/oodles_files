                    ...
                    <div class="card action-modal">
                        ...
                        <div class="card-body">
                            <div class="dz-list">
                                <ul>
                                    <li>
                                        <a href="javascript:void(0);" class="item-content item-link" data-bs-toggle="modal" data-bs-target="#exampleModal1">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);" class="item-content item-link" data-bs-toggle="modal" data-bs-target="#exampleModal2">
                                            ...
                                            <div class="dz-inner">
                                                <span class="ms-1">Option Bar</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);" class="item-content item-link" data-bs-toggle="modal" data-bs-target="#exampleModal4">
                                            ...
                                            <div class="dz-inner">
                                                <span class="ms-1">Success Bar</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="javascript:void(0);" class="item-content item-link" data-bs-toggle="modal" data-bs-target="#exampleModal6">
                            ...
                            <!-- Option Bar -->
                            <div class="modal fade" tabindex="-1" id="exampleModal2"  aria-labelledby="exampleModal2" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body text-center small p-4">
											<i class="fa fa-4x fa-info-circle text-secondary m-b15"></i>
                                            ...
                                            <div class="text-center m-t20">
                                                <a href="javascrpit:void(0);" class="btn btn-sm btn-danger m-r10">Cancel</a>
                            ...
                            <!-- Register -->
                            <div class="modal fade" tabindex="-1" id="exampleModal6"  aria-labelledby="exampleModal6" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
