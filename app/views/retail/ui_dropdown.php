<?php require APPROOT . '/views/inc_retail/header.php'; ?>
    ...
    <div class="sidebar">
		...
		<ul class="nav navbar-nav">	
			...
			<li><a class="nav-link" href="<?php echo URLROOT ?>/retail/welcome">
			...
			<li><a class="nav-link" href="<?php echo URLROOT ?>/retail/index">
			...
			<li><a class="nav-link" href="<?php echo URLROOT ?>/retail/pages">
			...
			<li><a class="nav-link" href="<?php echo URLROOT ?>/retail/ui_components">
			...
			<li><a class="nav-link" href="<?php echo URLROOT ?>/retail/notification">
			...
			<li><a class="nav-link" href="<?php echo URLROOT ?>/retail/profile">
			...
			<li><a class="nav-link" href="<?php echo URLROOT ?>/retail/messages">
				<span class="dz-icon bg-skyblue light">
					<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
						<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							<rect x="0" y="0" width="24" height="24"/>
			...
			<li><a class="nav-link" href="<?php echo URLROOT ?>/retail/onboading">
				<span class="dz-icon bg-red light">
					<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
						<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							<rect x="0" y="0" width="24" height="24"/>
