    ...
    <div class="container">
        <div class="row">
            <div class="container mt-3 mb-4 text-center">
                <h4 class="text">Enquiries</h4>
            </div>
            <div class="page-content bottom-content" style="padding-top:5px;">
                <div class="container">
                    <div class="notification-content">
                        <?php if ($data['id'] == 1) { ?>
                            <?php foreach ($data['get_solar_enquiry'] as $solar_enquiry) { ?>
                                <a href="#">
                                    <div class="notification">
                                        <h6>Solar Pump Enquiry</h6>
                                        <!-- <p>You has apply an job in Queenify Group as UI Designer</p> -->
                                        <div class="notification-footer">
                                            <span>
                                                ...
                                                <?php echo $solar_enquiry->created_at;?>
                                            </span>
                                            <p class="mb-0"><?php 
                                            if($solar_enquiry->status==1){echo "In Request";}elseif($solar_enquiry->status==2){echo "In Progress";}elseif($solar_enquiry->status=3){echo "Closed";}
                                            ?></p>
                                        </div>
                                    </div>
                                </a>
                        ...
                        ?>
                        <?php if ($data['id'] ==2 ) { ?>
                            <?php foreach ($data['get_ups_enquiry'] as $ups_enquiry) { ?>
                                <a href="#">
                                    <div class="notification">
                                        <h6>UPS Enquiry</h6>
                                        <!-- <p>You has apply an job in Queenify Group as UI Designer</p> -->
                                        <div class="notification-footer">
                                            <span>
                                                ...
                                                <?php echo $ups_enquiry->created_at;?>
                                            </span>
                                            <p class="mb-0"><?php 
                                            if($ups_enquiry->status==1){echo "In Request";}elseif($ups_enquiry->status==2){echo "In Progress";}elseif($ups_enquiry->status=3){echo "Closed";}
                                            ?>
                                            </p>
                                        </div>
                                    </div>
                        ...
                        ?>
                        <?php if ($data['id'] ==3 ) { ?>
                            <?php foreach ($data['get_ev_enquiry'] as $ev_enquiry) { ?>
                                <a href="#">
                                    <div class="notification">
                                        <h6>EV Enquiry</h6>
                                        <!-- <p>You has apply an job in Queenify Group as UI Designer</p> -->
                                        <div class="notification-footer">
                                            <span>
                                                ...
                                                <?php echo $ev_enquiry->created_at;?>
                                            </span>
                                            <p class="mb-0"><?php 
                                            if($ev_enquiry->status==1){echo "In Request";}elseif($ev_enquiry->status==2){echo "In Progress";}elseif($ev_enquiry->status=3){echo "Closed";}
                                            ?></p>
                                        </div>
                                    </div>
                                </a>
...
<script>
    $(".notification-content .notification").mouseenter(function() {
        $(".notification-content .notification").removeClass("active");
