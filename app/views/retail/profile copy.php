                ...
                <li class="d-flex align-items-center my-3">
                       ...
                       Name
                        ...
                        <div class="ms-3">
                            ...
                            <h6><a href="javascript:void(0);"><?php echo  $_SESSION['rexkod_user_name'];?></a></h6>    
                        </div>
                    </li>
                    <li class="d-flex align-items-center my-3">
                        <a href="javascript:void(0);" class="contact-icon">
                       Phone
                        ...
                        <div class="ms-3">
                            ...
                            <h6><a href="javascript:void(0);"><?php echo  $_SESSION['rexkod_user_phone'];?></a></h6>    
                        </div>
                    </li>
                    <li class="d-flex align-items-center my-3">
                        <a href="javascript:void(0);" class="contact-icon">
                     Email
                        ...
                        <div class="ms-3">
                            ...
                            <h6><a href="javascript:void(0);"><?php echo $_SESSION['rexkod_user_email'];?></a></h6>    
                        </div>
                    </li>
