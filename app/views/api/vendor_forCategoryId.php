          ...
          <div class="row g-3">
            ...
            <?php
                ...
                // $curModel = New Apis; 
                   ...
                   foreach($data['vendor_forCategoryId'] as $k) {
                     foreach($data['get_all_category_bycategoryId'] as $s){?>
                ...
                <div class="card-body d-flex align-items-center">
                  ...
                  <?php if($k->vendor_plan){
                    ...
                    <a class="product-thumbnail d-block" href="<?php echo URLROOT; ?>/api/find_productsFor_vendorId/<?php echo $k->vendor_id; ?>">
                      <img src="<?php echo URLROOT; ?>/uploads/<?php echo$s->category_img; ?>" alt="" style="height:50px;">
                    </a>
                  </div>
