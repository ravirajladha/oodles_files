          ...
          <div class="row g-3">
            ...
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card top-product-card">
                <div class="card-body">
                  <a class="product-thumbnail d-block" href="<?php echo URLROOT; ?>/api/products_forSubcategory/<?php echo $k->subcategory_id; ?>">
                    <img class="mb-2" src="<?php echo URLROOT; ?>/uploads/<?php echo $k->subcategory_img; ?>" alt="" style="height:120px;max-width:100%;">
                  </a>
