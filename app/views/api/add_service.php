        ...
        <div class="profile-wrapper-area py-3">
          ...
          <div class="card user-info-card">
            <div class="card-body p-4 d-flex align-items-center">
              ...
              <div class="user-info">
                ...
                ?></h5>
                <p class="mb-0 text-white">Add Service</p>
              </div>
            </div>
          </div>
          <!-- User Meta Data-->
          <div class="card user-data-card">
            <div class="card-body">
              ...
              <div class="row">
              <form method="post" action="<?php echo URLROOT; ?>/api/create_service" enctype="multipart/form-data" autocomplete="OFF">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <textarea placeholder="service details" name="p_details" class="form-control"></textarea>
                                        </div>
                                    </div>
