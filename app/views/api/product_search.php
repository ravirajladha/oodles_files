              ...
              <div class="card weekly-product-card">
                <div class="card-body d-flex align-items-center">
                  <div class="product-thumbnail-side">
                    <a class="product-thumbnail d-block" href="<?php echo URLROOT; ?>/pages/single_product/<?php echo $k->id;?>">
                      <img src="<?php echo URLROOT; ?>/uploads/<?php echo $k->p_image; ?>" width="50">
                    </a>
                  </div>
                  <div class="product-description">
              
                    <a class="product-title d-block" href="<?php echo URLROOT; ?>/pages/single_product/<?php echo $k->id; ?>"><?php echo ucwords($k->p_name); ?></a>
