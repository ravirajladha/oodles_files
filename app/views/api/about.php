...
<html lang="en">
  <head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="<?php echo URLROOT; ?>/assets2/img/icons/icon-72x72.png">
    <!-- Apple Touch Icon-->
    ...
    <!-- Stylesheet-->
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/assets2/style.css">
    <!-- Web App Manifest-->
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5"><img class="big-logo" src="img/core-img/logo-white.png" alt="">
            ...
            <!-- View As Guest-->
            <div class="view-as-guest mt-3"><a class="btn" href="<?php  echo URLROOT;?>/api/services">View as Guest</a></div>
          </div>
        </div>
      </div>
    </div>
