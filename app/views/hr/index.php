							...
							<div class="card-body">
								<div class="media align-items-center">
									...
									<div class="media-body text-end feature-icon-text">
										<p class="fs-18 text-white mb-2">Employees</p>
										<span class="fs-48 text-white font-w600">110</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card bg-info overflow-hidden">
							<div class="card-body">
								<div class="media align-items-center">
									...
									<div class="media-body text-end feature-icon-text">
										<p class="fs-18 text-white mb-2">Present</p>
						...
						<div class="card bg-success">
							<div class="card-body">
								<div class="media align-items-center">
									...
									<div class="media-body text-end feature-icon-text">
										<p class="fs-18 text-white mb-2">Absent</p>
						...
						<div class="card bg-secondary">
							<div class="card-body">
								<div class="media align-items-center">
									...
									<div class="media-body text-end feature-icon-text">
										<p class="fs-18 text-white mb-2">Leave</p>
							...
							<div class="col-xl-12">
								<div class="card d-flex flex-xl-column flex-sm-column flex-md-row flex-column">
									<div class="card-body text-center profile-bx">
										...
										<h4 class="fs-22 text-black mb-1">Attendance</h4>
										<p class="mb-4">Stat</p>
										<div class="row">
											<div class="col-4 p-0">
												...
												<span class="d-block">Permanent</span>
											</div>
											<div class="col-4 p-0">
												<div class="d-inline-block mb-2 relative donut-chart-sale">
												...
												<span class="d-block">Contract</span>
											</div>
											<div class="col-4 p-0">
												<div class="d-inline-block mb-2 relative donut-chart-sale">
													<span class="donut" data-peity='{ "fill": ["rgb(34, 172, 147)", "rgba(236, 236, 236, 1)"],   "innerRadius": 27, "radius": 10}'>8/9</span>
													<small class="text-black">87%</small>
												</div>
									...
									<div class="card-body col-xl-12 col-md-6 col-sm-12 activity-card">
										<h4 class="fs-18 text-black mb-3">Attendance</h4>
										<div class="media mb-4">
											...
											<div class="media-body">
												<p class="fs-14 mb-1 text-black font-w500">Leaves <strong>3 Leaves</strong></p>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header border-0 pb-0 flex-wrap">
										<h4 class="fs-20 text-black me-4 mb-2">Attendance</h4>
