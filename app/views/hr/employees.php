            ...
            <div class="container-fluid">
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">All Employees</a></li>
					</ol>
                </div>
									...
									<div class="card-body">	
										<div class="media mb-2">
											<div class="media-body">
												<p class="mb-1"><?php echo $employee->employee_name; ?></p>
												<h4 class="fs-20 text-black"><?php echo $employee->designation; ?></h4>
											</div>
										...
										<span class="text-primary font-w500 d-block mb-3">Employee ID: <span><?php echo $employee->mec_id; ?></span></span>
										<!-- <p class="fs-14"> <span><?php echo $employee->branch; ?></span></p> -->
										<div class="d-flex align-items-center mt-4">
											<a href="<?php echo URLROOT?>/hr/employee/<?php echo $employee->mec_id;?>" class="btn btn-primary light btn-rounded me-auto">View Profile</a>
