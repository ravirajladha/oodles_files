        ...
        <div class="page-titles">
           ...
           <div class="col-xl-6 col-lg-12">
                    ...
                    <div class="col-lg-12">
                                        ...
                                        <?php foreach($data['get_all_leaves'] as $leave_detail){ ?>
                                            <tr>
                                                ...
                                                <td class="badge light badge-success">
																	<?php if($leave_detail->status!=1){?>
                                         <form action="<?php echo URLROOT; ?>/hr/update_leave_status/<?php echo $leave_detail->leave_id; ?>" method="post">
                                         <select class='form-control' name="leave_status"  id="mySelect" onchange="this.form.submit()" style="font-size:12px;">
                        <option value="0" <?php if($leave_detail->status==0){echo "selected";} ?> >Requested</option>
                        <option value="1" <?php if($leave_detail->status==1){echo "selected";} ?> >Accept</option>
                        <option value="2" <?php if($leave_detail->status==2){echo "selected";} ?> >Reject</option>
                                                                </select>
                        ...
                        <option  <?php if($leave_detail->status==1){echo "selected";} ?>readonly >Accepted</option>
