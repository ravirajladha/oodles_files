                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="dz-list">
                                <ul>
									<li>
                                        <a href="<?php echo URLROOT ?>/retail/index" class="item-content item-link">
									...
									<li>
                                        <a href="<?php echo URLROOT ?>/retail/apply_form" class="item-content item-link">
                                    ...
                                    <li>
                                        <a href="<?php echo URLROOT ?>/retail/forgot_password" class="item-content item-link">
                                            <div class="dz-icon bg-red light">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path opacity="0.4" d="M8.23906 8.70907V7.36726C8.24922 5.37044 9.92585 3.73939 11.9988 3.73939C13.5839 3.73939 15.0065 4.72339 15.5248 6.19541C15.6975 6.65262 16.2056 6.89017 16.6628 6.73213C16.8864 6.66156 17.0693 6.50253 17.1709 6.29381C17.2725 6.08508 17.2929 5.84654 17.2116 5.62787C16.4393 3.46208 14.3461 2 11.9784 2C8.95036 2 6.48114 4.41626 6.46082 7.38714V8.91084L8.23906 8.70907Z" fill="#130F26"/>
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M7.7688 8.71106H16.2312C18.5886 8.71106 20.5 10.5807 20.5 12.8866V17.8245C20.5 20.1304 18.5886 22 16.2312 22H7.7688C5.41136 22 3.5 20.1304 3.5 17.8245V12.8866C3.5 10.5807 5.41136 8.71106 7.7688 8.71106ZM11.9949 17.3285C12.4928 17.3285 12.8891 16.9409 12.8891 16.4538V14.2473C12.8891 13.7702 12.4928 13.3826 11.9949 13.3826C11.5072 13.3826 11.1109 13.7702 11.1109 14.2473V16.4538C11.1109 16.9409 11.5072 17.3285 11.9949 17.3285Z" fill="#130F26"/>
                                                </svg>
                                            </div>
                                            <div class="dz-inner">
                                                <span class="dz-title">Forgot Password</span>
                                            </div>
                                        </a>
                                    </li>
									<li>
                                        <a href="<?php echo URLROOT ?>/retail/otp_confirm" class="item-content item-link">
                                            <div class="dz-icon bg-maroon light">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path opacity="0.4" d="M12.0865 22C11.9627 22 11.8388 21.9716 11.7271 21.9137L8.12599 20.0496C7.10415 19.5201 6.30481 18.9259 5.68063 18.2336C4.31449 16.7195 3.5544 14.776 3.54232 12.7599L3.50004 6.12426C3.495 5.35842 3.98931 4.67103 4.72826 4.41215L11.3405 2.10679C11.7331 1.96656 12.1711 1.9646 12.5707 2.09992L19.2081 4.32684C19.9511 4.57493 20.4535 5.25742 20.4575 6.02228L20.4998 12.6628C20.5129 14.676 19.779 16.6274 18.434 18.1581C17.8168 18.8602 17.0245 19.4632 16.0128 20.0025L12.4439 21.9088C12.3331 21.9686 12.2103 21.999 12.0865 22Z" fill="#130F26"/>
                                                    <path d="M11.3191 14.3209C11.1258 14.3219 10.9325 14.2523 10.7835 14.1091L8.86671 12.2656C8.57073 11.9793 8.56771 11.5145 8.86067 11.2262C9.15363 10.9369 9.63183 10.934 9.92882 11.2193L11.308 12.5451L14.6756 9.22479C14.9695 8.93551 15.4477 8.93257 15.7437 9.21792C16.0407 9.50425 16.0437 9.97003 15.7508 10.2573L11.8517 14.1022C11.7047 14.2474 11.5124 14.3199 11.3191 14.3209Z" fill="#130F26"/>
                                                </svg>
                                            </div>
                                            <div class="dz-inner">
                                                <span class="dz-title">OTP Confirm</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo URLROOT ?>/retail/messages" class="item-content item-link">
                                            <div class="dz-icon bg-red light">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="dz-inner">
                                                <span class="dz-title">Messages List</span>
                                            </div>
                                        </a>
                                    </li>
									<li>
                                        <a href="<?php echo URLROOT ?>/retail/messages_detail" class="item-content item-link">
                                            <div class="dz-icon bg-blue light">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<li>
                                        <a href="<?php echo URLROOT ?>/retail/search" class="item-content item-link">
                                            <div class="dz-icon bg-maroon light">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="dz-inner">
                                                <span class="dz-title">Search</span>
                                            </div>
                                        </a>
                                    </li>
									<li>
                                        <a href="<?php echo URLROOT ?>/retail/error" class="item-content item-link">
                                            <div class="dz-icon bg-red light">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M19.2015 4.32867C19.9463 4.57382 20.4496 5.26122 20.4496 6.02608L20.4999 12.6637C20.51 14.674 19.7752 16.6253 18.4265 18.1561C17.8126 18.8621 17.0175 19.4603 16.011 19.9996L12.438 21.9117C12.3273 21.9706 12.2065 22 12.0857 22C11.9649 22 11.8341 21.9706 11.7234 21.9117L8.12015 20.0486C7.1036 19.5191 6.30848 18.9307 5.68446 18.2345C4.31564 16.7244 3.55072 14.773 3.54065 12.7628L3.50039 6.12316C3.49033 5.3583 3.99357 4.67286 4.7283 4.41693L11.3409 2.1037C11.7334 1.96543 12.1662 1.96543 12.5688 2.1037L19.2015 4.32867ZM14.4207 14.0866C14.7126 13.8022 14.7126 13.3315 14.4207 13.0472L13.062 11.7224L14.4207 10.3995C14.7126 10.1152 14.7126 9.65429 14.4207 9.35913C14.1289 9.07476 13.6457 9.07476 13.3539 9.35913L11.9951 10.6839L10.6364 9.35913C10.3445 9.07476 9.87143 9.07476 9.56949 9.35913C9.27761 9.65429 9.27761 10.1152 9.56949 10.3995L10.9282 11.7224L9.56949 13.0472C9.27761 13.3315 9.27761 13.8022 9.56949 14.0866C9.72046 14.2337 9.91169 14.3013 10.1029 14.3013C10.3042 14.3013 10.4955 14.2337 10.6364 14.0866L11.9951 12.7628L13.3539 14.0866C13.5048 14.2337 13.6961 14.3013 13.8873 14.3013C14.0785 14.3013 14.2798 14.2337 14.4207 14.0866Z" fill="#130F26"/>
                                                </svg>
                                            </div>
                                            <div class="dz-inner">
                                                <span class="dz-title">Error Page</span>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
