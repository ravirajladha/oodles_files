...
<div class="page-wraper">
    ...
    <div class="page-content">
        ...
        <div class="container" style="margin-top:25px">
            ...
            <form class="multisteps_form" id="wizard" method="POST" action="<?php echo URLROOT?>/user/user_register">
    ...
    <footer class="footer fixed">
        <div class="container">
            <a href="<?php echo URLROOT; ?>/user/login" class="btn btn-primary light btn-rounded text-primary d-block">Login</a>
        </div>
    </footer>
    <!-- Footer End -->
