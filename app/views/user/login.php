...
?>
    ...
    <div class="page-content">
        ...
        <div class="container" style="margin-top:75px">
            ...
            <form class="multisteps_form" id="wizard" method="POST" action="<?php echo URLROOT?>/user/user_login">
    ...
    <footer class="footer fixed">
        <div class="container">
            <a href="<?php echo URLROOT?>/user/register" class="btn btn-primary light btn-rounded text-primary d-block">Create Account</a>
        </div>
    </footer>
    <!-- Footer End -->
