                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-responsive-md">
                                        <thead>
                                            <tr>
                                                <th class="width80"><strong>LEAVE ID</strong></th>
                                        ...
                                        <?php foreach($data['get_all_leaves'] as $leave_detail){ ?>
                                            <tr>
                                                ...
                                                <form action="<?php echo URLROOT; ?>/user/hod_approval/<?php echo $leave_detail->leave_id; ?>" method="post">
                                         <select class='form-control' name="hod_approval"  id="mySelect" onchange="this.form.submit()" >
                        <option value="0" <?php if($leave_detail->hod_approved==0){echo "selected";} ?> >Requested</option>
