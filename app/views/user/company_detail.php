...
<?php require APPROOT . '/views/inc_user/navbar_user.php'; ?>
        ...
        <div class="content-body fb">
			<div class="dz-banner-heading">
                <div class="overlay-black-light">
                    <img src="<?php echo URLROOT ?>/assets_retail/images/bg1.png" class="bnr-img" alt="">
                </div>
            </div>
            <div class="container company-detail">
                <div class="media media-60">
                    <img src="<?php echo URLROOT ?>/assets_retail/images/logo/company-logo2.png" alt="">
                </div>
                <div class="detail-content">
                    <div class="flex-1">
                        <h4>Highspeed Studios.</h4>
                        <p>Medan, Indonesia</p>
                    </div>
                    <div class="text-end">
                ...
                <ul class="contact-box">
                    <li class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <h6><a href="javascript:void(0);">+51 632 445 556</a></h6>    
                        </div>
                    </li>
                    <li class="d-flex align-items-center my-3">
                        ...
                        <div class="ms-3">
                            ...
                            <h6><a href="javascript:void(0);">highspeedst@mail.com</a></h6>    
                        </div>
                    </li>
                    <li class="d-flex align-items-center">
                        <a href="javascript:void(0);" class="contact-icon">
                        ...
                        <div class="ms-3">
                            ...
                            <h6><a href="javascript:void(0);">highspeed.studio</a></h6>    
                        </div>
                    </li>
                </ul>
	...
	<div class="footer fixed">
		<div class="container">
			<a href="<?php echo URLROOT ?>/retail/notification" class="btn btn-primary text-start w-100 btn-rounded">21 Available Jobs
				<svg class="ms-auto" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path fill-rule="evenodd" clip-rule="evenodd" d="M8.74358 6L4.33333 1.66667L6 -2.54422e-07L12 6L6 12L4.33335 10.3333L8.74358 6Z" fill="white"/>
				</svg>
			</a>
		</div>
	</div>
