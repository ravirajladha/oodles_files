    ...
    <div class="page-content bottom-content ">
        <div class="dz-banner-heading">
            <div class="overlay-black-light">
                <img src="<?php echo URLROOT ?>/assets_retail/images/bg2.png" class="bnr-img" alt="">
            </div>
        </div>
        <div class="container profile-area">
            <div class="profile">
                <div class="media media-100">
                    <img src="<?php echo URLROOT ?>/assets_retail/images/message/pic6.jpg" alt="/">    
                </div>
                <div class="mb-2">
            ...
            <ul class="contact-profile">
                <li class="d-flex align-items-center">
                    <a href="<?php echo URLROOT ?>/retail/messages" class="contact-icon">
