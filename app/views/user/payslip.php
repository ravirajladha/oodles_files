    ...
    <div class="container-fluid">
        <div class="row page-titles mx-0">
            <div class="col-sm-12 p-md-0" >
                ...
                <!-- <a target="_BLANK" href="<?php echo URLROOT; ?>/user/print_payslip/<?php echo $employee->mec_id; ?>"> <button type="button" class="btn btn-primary" style="float:right;"><i class="fa fa-print fa-lg"></i>Print</button></a> -->
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header center"><p style="text-align:center;"> Payslip for the month of August, 2020</p></div>
                    <div class="card-body" >
                        <div class="row mb-5">
