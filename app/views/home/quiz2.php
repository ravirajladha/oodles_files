    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-3">
                ...
                <select name="type" class="form-control" id="subject">
        ...
        <div class="col-xl-4 p-t-20">
            ...
            <div class="col-xl-4 mt-5">
                <button class="btn btn-success"><a href="<?php echo URLROOT; ?>/home/all_quizes">View All</a></button><!-- hereeeeeeeeeeeee -->
            </div>
            <div class="col-xl-4 p-t-20">
            </div>
        </div>
...
<section class="portfolio">
        <div class="container">
            <div class="row">
                ...
                <?php foreach ($data['get_all_quiz_by_category'] as $quiz) { ?>
