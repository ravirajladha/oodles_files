...
<section>
    <div class="container">
        ...
        <form action="<?php echo URLROOT; ?>/home/payment_details3" method="post">
            ...
            <div class="col-lg-4">
                <div class="bg-white shadow-lg" style="min-height:250px;">
                    ...
                    <div class="bg-white shadow-sm" style="margin:15px 15px;">
                        ...
                        <p class="" style="font-size: 15px;color:var(--insur-base);">&#x20B9;3,495</p>
                        </div>
                ...
                <div class="bg-white shadow-lg" style="min-height:250px;">
                    ...
                    <div class="card-footer text-left" style="background-color: #ffff; padding: 10px 30px;">
                        ...
                        <div class="d-flex justify-content-between" style="margin-top:15px;">
                            ...
                            <div class="about-one__btn-box">
                                <!-- <a href="<?php echo URLROOT; ?>/home/payment_details3" class="thm-btn about-one__btn">Continue</a> -->
