                ...
                <div class="bg-white shadow-lg">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 text-left">
                                <div class="row" style="margin-top: 30px;margin-left:auto;margin-right:auto;">
                                    ...
                                    <div class="col-6">
                                        <h5 style="font-size: 14px;color: #000;">Carrer Report</h5>
                                    </div>
                                </div>
                    ...
                    <div class="bg-white shadow-lg" style="margin: 20px 40px 80px 40px;">
                        <div class="row text-left" style="margin-left:5px;">
                            ...
                            <p class="" style="font-size: 12px;color: #000;">The career guidance report is powered by our partner Bodhami Learning.</p>
                        </div>
                ...
                <div class="bg-white shadow-lg">
                    ...
                    <div class="row">
                            <div class="col-lg-12 text-left">
                                <div class="row" style="margin-top: 30px;margin-left:auto;margin-right:auto;">
                                    ...
                                    <div class="col-6">
                                        <h5 style="font-size: 14px;color: #000;">₹1,266.95</h5>
                                    </div>
                                </div>
                                <div class="row"  style="margin-top: 20px;margin-left:auto;margin-right:auto;">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        <h5 style="font-size: 14px;color: #000;">₹228.05</h5>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-footer text-left" style="background-color: #ffff;">
                                <div class="row"  style="margin-top: 10px;">
                                    ...
                                    <div class="col-6">
                                        <h5 style="font-size: 16px;color: var(--insur-base);font-weight:bold;">₹1,495</h5>
                                    </div>
                                </div>
