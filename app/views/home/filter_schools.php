...
<div class="col-xl-3 col-lg-6 col-md-6 filter-item <?php echo $detail->curriculum?>">
                        <div class="portfolio__single">
                            <div class="portfolio__img">
                                ...
                                <div class="portfolio__content">
                                    ...
                                    <h4 class="portfolio__title"><a href="<?php echo URLROOT; ?>/home/school/<?php echo $detail->id ?>"><?php echo $detail->institute_name ?></a></h4>
                                </div>
                            </div>
                    ...
                    <?php if ($count == 0) { ?>
                       ...
                       No Such School Found, Try again.
