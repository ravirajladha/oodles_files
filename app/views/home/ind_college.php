...
<section class="page-header">
    ...
    <div class="container">
        <div class="page-header__inner">
            ...
            <h2><i class="fa fa-university" aria-hidden="true"></i><?php echo $detail->college_name; ?></h2>
            <style>
                .checked_special {
                    color: orange;
                }
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <?php if (isset($detail->college_address)) { ?> <i class="fa fa-map-marker" aria-hidden="true"></i>&nbsp;<?php echo $detail->college_address ?> <?php } ?>&ensp;
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    ...
                    <?php if (isset($detail->college_type)) { ?><i class="fa fa-star" aria-hidden="true"></i>
                        <?php if ($detail->college_type == 1) {
                            echo "Private";
                        } elseif ($detail->college_type == 1) {
                            echo "Government";
                        } else {
                            echo "OodlesIN"; ?> <?php }
                                        } ?></i>
                        ...
                        <div class="get-insurance__tab">
                            <div class="get-insurance__tab-box tabs-box">
                                <ul class="tab-buttons clearfix list-unstyled">
                                    ...
                                    <?php if ((!empty($detail->course_offered)) ||  (!empty($detail->course_course))) { ?>
                                        <li data-tab="#courses" class="tab-btn "><span>Courses</span></li>
                                    <?php } ?>
                                    <?php if ((!empty($detail->admission_criteria)) ||  (!empty($detail->mode_of_admission)) || (!empty($detail->entrance_exam)) || (!empty($detail->how_to_apply))) { ?>
                                        <li data-tab="#admission" class="tab-btn"><span>Admission </span></li>
                                    <?php } ?>
                                    <li data-tab="#reviews" class="tab-btn "><span>Reviews</span></li>

                                    <?php if ((!empty($detail->cut_off_marks))) { ?>
                                        <li data-tab="#cutoff" class="tab-btn"><span>Cutoff</span></li>
                                    <?php } ?>
                                    <?php if ((!empty($detail->placement)) || (!empty($detail->placement_images))) { ?>
                                        <li data-tab="#placement" class="tab-btn"><span>Placement</span></li>
                                    <?php } ?>
                                    <?php if ((!empty($detail->gallery))) { ?>
                                        <li data-tab="#gallery" class="tab-btn"><span>Gallery</span></li>
                                    <?php } ?>
                                    <?php if ((!empty($detail->scholarship))) { ?>
                                        <li data-tab="#scholarship" class="tab-btn"><span>Scholarship</span></li>
                                    <?php } ?>
                                    ...
                                    <?php if ((!empty($detail->hostel)) || (!empty($detail->hostel_images))) { ?>
                                        <li data-tab="#hostel" class="tab-btn"><span>Hostel</span></li>
                                    <?php } ?>
                                    ...
                                    <?php if ((!empty($detail->alumni)) || (!empty($detail->alumni_images))) { ?>
                                        <li data-tab="#alumni" class="tab-btn"><span>Alumni</span></li>
                                    <?php } ?>
                                </ul>
                                <div class="tabs-content">
                                    ...
                                    <div class="tab active-tab" id="overview">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                <div class="portfolio-details__img" style="text-align:center;">
                                                                    <img src="<?php echo URLROOT ?>/uploads/<?php echo $detail->college_image ?>" alt="" style="height:200px;width:200px; display:inline-block;">
                                                                </div>

                                                            </div>
                                                        </div>

                                                        <h3 style="text-align:center;" class="portfolio-details__title"><?php echo $detail->college_name ?></h3>

                                                        <p class="portfolio-details__text-2"><?php echo $detail->college_info ?></p>
                                                    ...
                                                    <div class="portfolio-details__content-right">
                                                        <div class="portfolio-details__details-box">
                                                            <ul class="list-unstyled portfolio-details__details-list">
                                                                ...
                                                                <?php if (!empty($detail->auth_email)) { ?>
                                                                    <li>
                                                                        <p class="portfolio-details__client">Email Id</p>
                                                                        <h4 class="portfolio-details__name"><a href="mailto:<?php echo $detail->authorized_email ?>" ?><?php echo $detail->auth_email ?></a></h4>
                                                                    </li>
                                                                <?php } ?>
                                                                ...
                                                                <?php if (!empty($detail->mode_of_admission)) { ?>
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <h4 class="portfolio-details__name"><?php if ($detail->mode_of_admission == 1) {
                                                                                                                echo "Online";
                                                                                                            } elseif ($detail->mode_of_admission == 2) {
                                                                                                                echo "Offline";
                                                                                                            } else {
                                                                                                                echo "Online & Offline";
                                                                                                            } ?></h4>
                                                                ...
                                                                <?php } ?>
                                                                <?php if (!empty($detail->registered_address)) { ?>
                                                                    <li>
                                                                        <p class="portfolio-details__client">Registered Address</p>
                                                                        <h4 class="portfolio-details__name"><?php echo $detail->registered_address ?></h4>
                                                                    </li>
                                                                <?php } ?>

                                                                <?php if (!empty($detail->accredited_by)) { ?>
                                                                    <li>
                                                                        <p class="portfolio-details__client">Accredited By</p>
                                                                        <?php if ($detail->accredited_by == 1) { ?>
                                                                            <h4 class="portfolio-details__name">A</h4>
                                                                        <?php    } elseif ($detail->accredited_by == 2) { ?>
                                                                            <h4 class="portfolio-details__name">B</h4>
                                                                        <?php } else { ?>
                                                                            <h4 class="portfolio-details__name">C</h4>
                                                                        <?php  } ?>
                                                                    </li>
                                                                <?php } ?>

                                                                <?php if (!empty($detail->accreditation_no)) { ?>
                                                                    <li>
                                                                ...
                                                                <?php if (!empty($detail->facility)) { ?>
                                                                    <li>
                                                                        <p class="portfolio-details__client">Facilites</p>
                                                                        <h4 class="portfolio-details__name">
                                                                            ...
                                                                            foreach ($array as $value) {
                                                                                ...
                                                                                if ($value == 1) {
                                                                                    ...
                                                                                    $fac = "Medical Ventialated";
                                                                                }
                                                                                if ($count == 1) {
                                                                                    $fac_main = $fac;
                                                                                } else {
                                                                                    $fac_main = $fac_main . "," . $fac;
                                                                                }
                                                                            ?>
                                        ...
                                        <?php if (!empty($detail->course_offered)) { ?>
                                            <div class="card">
                                                <div class="card-header">
                                                    Courses Offered
                                                </div>
                                                <div class="card-body">
                                                    <h5 class="card-title table-responsive-sm table-responsive-md table-responsive-lg"><?php echo $detail->course_offered ?> </h5>
                                                </div>
                                            </div>
                                            <br>
                                        <?php } ?>
                                        <!-- <?php if (!empty($detail->college_course)) { ?>
                                            <div class="card">
                                                <div class="card-header">
                                                    College Stream
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        foreach ($array as $value) {
                                                            $homeMod = new Homes;
                                                            $college_course_detail = $homeMod->get_college_course_detail($value); ?>

                                                            <div class="col-xl-4 col-lg-4 col-md-6">
                                                                <div class="services-two__single">
                                                                    <div class="services-two__icon-box">
                                                                        <div class="services-two__icon">
                                                                            <img src="<?php echo URLROOT; ?>/uploads/<?php echo $college_course_detail->college_course_image ?>" alt="" style="height:60px;width:60px; clip-path: circle();">
                                                                        </div>
                                                                    </div>
                                                                    <h3 class="services-two__title"><a href=""><?php echo $college_course_detail->college_course ?></a></h3>
                                    ...
                                    <div class="tab " id="admission">
                                        <div class="get-insurance__content">
                                            <?php if (!empty($detail->admission_criteria)) { ?>
                                                <div class="card">
                                                    <div class="card-header">
                                                        Basic Admission Criteria
                                                    </div>
                                                    ...
                                                    <div class="card-body">
                                                        <!-- <h5 class="card-title">
                                                            <ul class="list-group">
                                                                ...
                                                                <?php $array = explode(',', $detail->entrance_exam);
                                                                foreach ($array as $value) //loop over values
                                                                { ?>
                                    ...
                                    <div class="tab" id="reviews">
                                        <div class="get-insurance__content">
                                            ...
                                            foreach ($data['get_rating_college'] as $rating_detail) {
                                            ...
                                            $accomodation_rating_sum = 0;
                                            foreach ($data['get_rating_college'] as $rating_detail) {
                                                if (!empty($rating_detail->accomodation)) {
                                                    $accomodation_count++;
                                                    $accomodation_rating_sum += $rating_detail->accomodation;
                                                }
                                            }
                                            if (!empty($rating_detail->accomodation)) {
                                                $final_accomodation_rating = $accomodation_rating_sum / $accomodation_count;
                                            } else {
                                                $final_accomodation_rating = 10;
                                            }
                                            $faculty_count = 0;
                                            ...
                                            $placement_count = 0;
                                            $placement_rating_sum = 0;
                                            foreach ($data['get_rating_college'] as $rating_detail) {
                                                if (!empty($rating_detail->placement)) {
                                                    $placement_count++;
                                                    $placement_rating_sum += $rating_detail->placement;
                                                }
                                            }
                                            if (!empty($rating_detail->placement)) {
                                                $final_placement_rating = $placement_rating_sum / $placement_count;
                                            } else {
                                                $final_placement_rating = 10;
                                            }
                                            $social_count = 0;
                                            $social_rating_sum = 0;
                                            foreach ($data['get_rating_college'] as $rating_detail) {
                                                if (!empty($rating_detail->social)) {
                                                    $social_count++;
                                                    $social_rating_sum += $rating_detail->social;
                                                }
                                            }
                                            if (!empty($rating_detail->social)) {
                                                $final_social_rating = $social_rating_sum / $social_count;
                                            } else {
                                                $final_social_rating = 10;
                                            }
                                            $course_count = 0;
                                            $course_rating_sum = 0;
                                            foreach ($data['get_rating_college'] as $rating_detail) {
                                                if (!empty($rating_detail->course)) {
                                                    $course_count++;
                                                    $course_rating_sum += $rating_detail->course;
                                                }
                                            }
                                            if (!empty($rating_detail->course)) {
                                                $final_course_rating = $course_rating_sum / $course_count;
                                            } else {
                                                $final_course_rating = 10;
                                            }
                                            $campus_count = 0;
                                            $campus_rating_sum = 0;
                                            foreach ($data['get_rating_college'] as $rating_detail) {
                                                if (!empty($rating_detail->campus)) {
                                                    $campus_count++;
                                                    $campus_rating_sum += $rating_detail->campus;
                                                }
                                            }
                                            if (!empty($rating_detail->campus)) {
                                                $final_campus_rating = $campus_rating_sum / $campus_count;
                                            } else {
                                                $final_campus_rating = 10;
                                            }
                                            ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="card border-dark mb-3" style="max-width: 12rem;">
                                                        <div class="card-header" style="float:center;">Accomodation</div>
                                                        <div class="card-body text-dark">
                                                            <h5 class="card-title text-center"><?php echo sprintf('%0.1f', round($final_accomodation_rating, 1)); ?>/10</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="card border-dark mb-3" style="max-width: 12rem;">
                                                        <div class="card-header" style="float:center;">Placement</div>
                                                        <div class="card-body text-dark">
                                                            <h5 class="card-title text-center"><?php echo sprintf('%0.1f', round($final_placement_rating, 1)); ?>/10</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="card border-dark mb-3" style="max-width: 12rem;">
                                                        <div class="card-header" style="float:center;">Social Life</div>
                                                        <div class="card-body text-dark">
                                                            <h5 class="card-title text-center"><?php echo sprintf('%0.1f', round($final_social_rating, 1)); ?>/10</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="card border-dark mb-3" style="max-width: 12rem;">
                                                        <div class="card-header" style="float:center;">Course</div>
                                                        <div class="card-body text-dark">
                                                            <h5 class="card-title text-center"><?php echo sprintf('%0.1f', round($final_course_rating, 1)); ?>/10</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="card border-dark mb-3" style="max-width: 12rem;">
                                                        <div class="card-header" style="float:center;">Campus Life</div>
                                                        <div class="card-body text-dark">
                                                            <h5 class="card-title text-center"><?php echo sprintf('%0.1f', round($final_campus_rating, 1)); ?>/10</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            $college_id = $detail->id;
                                            ?>
                                            <form action="<?php echo URLROOT; ?>/home/rating/<?php echo $user_id ?>/<?php echo $college_id ?>" method="POST">
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="rating" style="float:left;">
                                                                ...
                                                                <input type="radio" id="star10_2" name="review_accomodation_10" value="10" /><label for="star10_2" title="Rocks!">5 stars</label>
                                                                <input type="radio" id="star9_2" name="review_accomodation_9" value="9" /><label for="star9_2" title="Rocks!">4 stars</label>
                                                                <input type="radio" id="star8_2" name="review_accomodation_8" value="8" /><label for="star8_2" title="Pretty good">3 stars</label>
                                                                <input type="radio" id="star7_2" name="review_accomodation_7" value="7" /><label for="star7_2" title="Pretty good">2 stars</label>
                                                                <input type="radio" id="star6_2" name="review_accomodation_6" value="6" /><label for="star6_2" title="Meh">1 star</label>
                                                                <input type="radio" id="star5_2" name="review_accomodation_5" value="5" /><label for="star5_2" title="Meh">5 stars</label>
                                                                <input type="radio" id="star4_2" name="review_accomodation_4" value="4" /><label for="star4_2" title="Kinda bad">4 stars</label>
                                                                <input type="radio" id="star3_2" name="review_accomodation_3" value="3" /><label for="star3_2" title="Kinda bad">3 stars</label>
                                                                <input type="radio" id="star2_2" name="review_accomodation_2" value="2" /><label for="star2_2" title="Sucks big tim">2 stars</label>
                                                                <input type="radio" id="star1_2" name="review_accomodation_1" value="1" /><label for="star1_2" title="Sucks big time">1 star</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6"></div>
                                                        ...
                                                        <div class="col-md-6"></div>
                                                        <div class="col-md-3">Placement</div>
                                                        <div class="col-md-3">
                                                            <div class="rating" style="float:left;">

                                                                <input type="radio" id="star10_5" name="review_placement_10" value="10" /><label for="star10_5" title="Rocks!">5 stars</label>
                                                                <input type="radio" id="star9_5" name="review_placement_9" value="9" /><label for="star9_5" title="Rocks!">4 stars</label>
                                                                <input type="radio" id="star8_5" name="review_placement_8" value="8" /><label for="star8_5" title="Pretty good">3 stars</label>
                                                                <input type="radio" id="star7_5" name="review_placement_7" value="7" /><label for="star7_5" title="Pretty good">2 stars</label>
                                                                <input type="radio" id="star6_5" name="review_placement_6" value="6" /><label for="star6_5" title="Meh">1 star</label>
                                                                <input type="radio" id="star5_5" name="review_placement_5" value="5" /><label for="star5_5" title="Meh">5 stars</label>
                                                                <input type="radio" id="star4_5" name="review_placement_4" value="4" /><label for="star4_5" title="Kinda bad">4 stars</label>
                                                                <input type="radio" id="star3_5" name="review_placement_3" value="3" /><label for="star3_5" title="Kinda bad">3 stars</label>
                                                                <input type="radio" id="star2_5" name="review_placement_2" value="2" /><label for="star2_5" title="Sucks big tim">2 stars</label>
                                                                <input type="radio" id="star1_5" name="review_placement_1" value="1" /><label for="star1_5" title="Sucks big time">1 star</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6"></div>
                                                        <div class="col-md-3">Social Life</div>
                                                        <div class="col-md-3">
                                                            <div class="rating" style="float:left;">

                                                                <input type="radio" id="star10_6" name="review_social_10" value="10" /><label for="star10_6" title="Rocks!">5 stars</label>
                                                                <input type="radio" id="star9_6" name="review_social_9" value="9" /><label for="star9_6" title="Rocks!">4 stars</label>
                                                                <input type="radio" id="star8" name="review_social_8" value="8" /><label for="star8_6" title="Pretty good">3 stars</label>
                                                                <input type="radio" id="star7_6" name="review_social_7" value="7" /><label for="star7_6" title="Pretty good">2 stars</label>
                                                                <input type="radio" id="star6_6" name="review_social_6" value="6" /><label for="star6_6" title="Meh">1 star</label>
                                                                <input type="radio" id="star5_6" name="review_social_5" value="5" /><label for="star5_6" title="Meh">5 stars</label>
                                                                <input type="radio" id="star4_6" name="review_social_4" value="4" /><label for="star4_6" title="Kinda bad">4 stars</label>
                                                                <input type="radio" id="star3_6" name="review_social_3" value="3" /><label for="star3_6" title="Kinda bad">3 stars</label>
                                                                <input type="radio" id="star2_6" name="review_social_2" value="2" /><label for="star2_6" title="Sucks big tim">2 stars</label>
                                                                <input type="radio" id="star1_6" name="review_social_1" value="1" /><label for="star1_6" title="Sucks big time">1 star</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6"></div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="rating" style="float:left;">
                                                                ...
                                                                <input type="radio" id="star10_7" name="review_course_10" value="10" /><label for="star10_7" title="Rocks!">5 stars</label>
                                                                <input type="radio" id="star9_7" name="review_course_9" value="9" /><label for="star9_7" title="Rocks!">4 stars</label>
                                                                <input type="radio" id="star8_7" name="review_course_8" value="8" /><label for="star8_7" title="Pretty good">3 stars</label>
                                                                <input type="radio" id="star7_7" name="review_course_7" value="7" /><label for="star7_7" title="Pretty good">2 stars</label>
                                                                <input type="radio" id="star6_7" name="review_course_6" value="6" /><label for="star6_7" title="Meh">1 star</label>
                                                                <input type="radio" id="star5_7" name="review_course_5" value="5" /><label for="star5_7" title="Meh">5 stars</label>
                                                                <input type="radio" id="star4_7" name="review_course_4" value="4" /><label for="star4_7" title="Kinda bad">4 stars</label>
                                                                <input type="radio" id="star3_7" name="review_course_3" value="3" /><label for="star3_7" title="Kinda bad">3 stars</label>
                                                                <input type="radio" id="star2_7" name="review_course_2" value="2" /><label for="star2_7" title="Sucks big tim">2 stars</label>
                                                                <input type="radio" id="star1_7" name="review_course_1" value="1" /><label for="star1_7" title="Sucks big time">1 star</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6"></div>
                                                        <div class="col-md-3">Campus Life</div>
                                                        <div class="col-md-3">
                                                            <div class="rating" style="float:left;">

                                                                <input type="radio" id="star108" name="review_campus_10" value="10" /><label for="star108" title="Rocks!">5 stars</label>
                                                                <input type="radio" id="star98" name="review_campus_9" value="9" /><label for="star98" title="Rocks!">4 stars</label>
                                                                <input type="radio" id="star88" name="review_campus_8" value="8" /><label for="star88" title="Pretty good">3 stars</label>
                                                                <input type="radio" id="star78" name="review_campus_7" value="7" /><label for="star78" title="Pretty good">2 stars</label>
                                                                <input type="radio" id="star68" name="review_campus_6" value="6" /><label for="star68" title="Meh">1 star</label>
                                                                <input type="radio" id="star58" name="review_campus_5" value="5" /><label for="star58" title="Meh">5 stars</label>
                                                                <input type="radio" id="star48" name="review_campus_4" value="4" /><label for="star48" title="Kinda bad">4 stars</label>
                                                                <input type="radio" id="star38" name="review_campus_3" value="3" /><label for="star38" title="Kinda bad">3 stars</label>
                                                                <input type="radio" id="star28" name="review_campus_2" value="2" /><label for="star28" title="Sucks big tim">2 stars</label>
                                                                <input type="radio" id="star18" name="review_campus_1" value="1" /><label for="star18" title="Sucks big time">1 star</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6"></div>
                                                    </div><br>
                                    ...
                                    <!--tab-->
                                    <div class="tab" id="alumni">
                                        <div class="get-insurance__content">
                                            <div class="card">
                                                <div class="card-header">
                                                    Alumni
                                                </div>
                                                <?php if (!empty($detail->alumni)) { ?>
                                                    <div class="card-body">
                                                        <p class="portfolio-details__text-1"><?php echo $detail->alumni ?> </p>
                                                    </div>
                                                <?php } ?>
                                            ...
                                            <!-- <h6 class="portfolio-details__title" style="font-size:20px;">Alumni</h6>
                                            <p class="portfolio-details__text-1"><?php echo $detail->alumni ?> </p>
                                            </h6> -->
                                        </div>
                                    </div>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo URLROOT; ?>/home/college_login/<?php echo $college_id ?>" autocomplete="off" class="register-form">
