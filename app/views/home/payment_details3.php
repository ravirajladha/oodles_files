                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 text-left">
                                <div class="row" style="margin-top: 30px;margin-left:auto;margin-right:auto;">
                                    ...
                                    <div class="col-6">
                                        <h5 style="font-size: 14px;color: #000;">Career Guidance Report & 2 Counseling</h5>
                                    </div>
                                </div>
                    ...
                    <div class="card-footer" style="background-color: #ffff;">
                        <div class="d-flex justify-content-between">
                            <div class="about-one__btn-box">
                                ...
                                <!-- <a href="window.history.back();" class="thm-btn-orange about-one__btn">Previous</a> -->
                            </div>
                            <div class="about-one__btn-box">
                ...
                <div class="bg-white shadow-lg">
                    ...
                    <div class="row">
                            <div class="col-lg-12 text-left">
                                <div class="row" style="margin-top: 30px;margin-left:auto;margin-right:auto;">
                                    ...
                                    <div class="col-6">
                                        <h5 style="font-size: 14px;color: #000;">₹2,961.86</h5>
                                    </div>
                                </div>
                                <div class="row"  style="margin-top: 20px;margin-left:auto;margin-right:auto;">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        <h5 style="font-size: 14px;color: #000;">₹533.14</h5>
                                    </div>
                                </div>
                            </div>
                    </div>
                    <div class="card-footer text-left" style="background-color: #ffff;">
                                <div class="row"  style="margin-top: 10px;">
                                    ...
                                    <div class="col-6">
                                        <h5 style="font-size: 16px;color: var(--insur-base);font-weight:bold;">₹3,495</h5>
                                    </div>
                                </div>
