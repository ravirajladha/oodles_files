...
<body
	...
	<div class="page-wrapper">
					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown dropdown-user">
							<a class="dropdown-toggle" data-bs-toggle="dropdown" data-hover="dropdown"
								...
								<span class="username username-hide-on-mobile"> College
							</a>
							<ul class="dropdown-menu dropdown-menu-default">
								...
								<li>
									<a href="<?php echo URLROOT; ?>/college/logout">
		...
		<div class="page-container">
			<!-- start sidebar menu -->
			<?php if(isset($_SESSION['rexkod_oodles_college_id'])){ ?>
					...
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="sidebar-user-panel">
								<div class="sidebar-user">
									...
									<div class="sidebar-user-details">
										<div class="user-name"><?php echo $_SESSION['rexkod_oodles_college_name']?></div>
										<div class="user-role">College</div>
									</div>
								</div>
							</li>
							...
							<li class="nav-item ">
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="<?php echo URLROOT; ?>/college/wallet" class="nav-link "> <span class="title">All
										Wallet</span>
										</a>
									</li>
							...
							<li class="nav-item ">
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="<?php echo URLROOT; ?>/college/students" class="nav-link "> <span class="title">All
										Students</span>
										</a>
									</li>
