	...
	<div class="page-wrapper">
		...
		<div class="page-header navbar navbar-fixed-top">
			<div class="page-header-inner ">
				<!-- logo start -->
				<div class="page-logo">
					<a href="<?php echo URLROOT; ?>/corporate/index">
					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown dropdown-user">
							<a class="dropdown-toggle" data-bs-toggle="dropdown" data-hover="dropdown" data-close-others="true">
								...
								<span class="username username-hide-on-mobile"> Corporate
							</a>
							<ul class="dropdown-menu dropdown-menu-default">
								...
								<li>
									<a href="<?php echo URLROOT; ?>/corporate/logout">
		...
		<div class="page-container">
			<!-- start sidebar menu -->
			<?php if (isset($_SESSION['rexkod_oodles_corporate_id'])) { ?>
						...
						<div id="remove-scroll" class="left-sidemenu">
							<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px;">
								...
								<li class="sidebar-user-panel">
									<div class="sidebar-user">
										...
										<div class="sidebar-user-details">
											<div class="user-name"><?php echo $_SESSION['rexkod_oodles_corporate_name'] ?></div>
											<div class="user-role">Corporate</div>
										</div>
									</div>
								</li>
								...
								<li class="nav-item">
									...
									<ul class="sub-menu">
										<li class="nav-item">
											<a href="<?php echo URLROOT; ?>/corporate/index" class="nav-link ">
								...
								<li class="nav-item ">
									...
									<ul class="sub-menu">
										<li class="nav-item">
											<a href="<?php echo URLROOT; ?>/corporate/scholarships" class="nav-link "> <span class="title">All
													Scholarships</span>
											</a>
										</li>

										<li class="nav-item">
											<a href="<?php echo URLROOT; ?>/corporate/scholarship_promotion" class="nav-link "> <span class="title">
													Scholarship Promotions</span>
											</a>
										</li>
									</ul>
								</li>
								<li class="nav-item ">
									<a href="<?php echo URLROOT; ?>/corporate/logout">
										<i class="icon-logout"></i> Log Out<span class="label label-rouded label-menu label-success">new</span> </a>
								</li>
