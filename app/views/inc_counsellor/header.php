	...
	<div class="page-wrapper">
		...
		<div class="page-header navbar navbar-fixed-top">
			<div class="page-header-inner ">
				<!-- logo start -->
				<div class="page-logo">
					<a href="<?php echo URLROOT?>/home/counsellor_index">
					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown dropdown-user">
							<a class="dropdown-toggle" data-bs-toggle="dropdown" data-hover="dropdown"
								...
								<span class="username username-hide-on-mobile"> Counsellor
							</a>
							<ul class="dropdown-menu dropdown-menu-default">
								...
								<li>
									<a href="<?php echo URLROOT; ?>/home/counsellor_logout">
		...
		<div class="page-container">
			<!-- start sidebar menu -->
			<!-- <?php if(isset($_SESSION['rexkod_oodles_counsellor_id'])){ ?>
							...
							<li class="sidebar-user-panel">
								<div class="sidebar-user">
									...
									<div class="sidebar-user-details">
										<div class="user-name"><?php echo $_SESSION['rexkod_oodles_counsellor_name']?></div>
