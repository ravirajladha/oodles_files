...
<?php $subscription = $data['get_ind_subscription'] ?>
					<form method="post" action="<?php echo URLROOT; ?>/admin/update_subscription/<?php echo $subscription->id;?>" enctype="multipart/form-data" autocomplete="OFF">
							...
							<div class="card-body row">
								...
								<div class="col-md-3 col-sm-3">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Name</label>
										<input type="text" id="name" name="name" class="form-control mdl-textfield__input" placeholder="<?php echo $subscription->name;?>" value="<?php echo $subscription->name;?>"  required>
								...
								<div class="col-md-3 col-sm-3">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Price</label>
										<input type="number" id="price" name="price" class="form-control mdl-textfield__input" placeholder="<?php echo $subscription->price;?>" value="<?php echo $subscription->price;?>" >
									</div>
								</div>
								<div class="col-md-3 col-sm-3">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Offer Price</label>
										<input type="number" id="offer_price" name="offer_price" class="form-control mdl-textfield__input" placeholder="<?php echo $subscription->offer_price;?>" value="<?php echo $subscription->offer_price;?>" >
									</div>
								</div>
								<div class="col-md-3 col-sm-3">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label for="list2" class="">Validity<span>*</span></label>
										<br>
										<select name="validity" class="form-control" >
										<option value="">-Select Month-</option>
										<option value="1" <?php if($subscription->validity=="1"){ echo "selected";}?>>1 Month</option>
												<option value="2" <?php if($subscription->validity=="2"){ echo "selected";}?>>2 Month</option>
												<option value="3" <?php if($subscription->validity=="3"){ echo "selected";}?>>3 Month</option>
												<option value="4" <?php if($subscription->validity=="4"){ echo "selected";}?>>4 Month</option>
												<option value="5" <?php if($subscription->validity=="5"){ echo "selected";}?>>5 Month</option>
												<option value="6" <?php if($subscription->validity=="6"){ echo "selected";}?>>6 Month</option>
												<option value="7" <?php if($subscription->validity=="7"){ echo "selected";}?>>7 Month</option>
												<option value="8" <?php if($subscription->validity=="8"){ echo "selected";}?>>8 Month</option>
												<option value="9" <?php if($subscription->validity=="9"){ echo "selected";}?>>9 Month</option>
												<option value="10" <?php if($subscription->validity=="10"){ echo "selected";}?>>10 Month</option>
												<option value="11" <?php if($subscription->validity=="11"){ echo "selected";}?>>11 Month</option>
												<option value="12" <?php if($subscription->validity=="12"){ echo "selected";}?>>12 Month</option>
										</select>
									</div>
								</div>
								<div class="col-md-3 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<input type="number" id="package_id" name="package_id" class="form-control mdl-textfield__input" placeholder="<?php if($subscription->package_id){
    echo $subscription->package_id;
}?>" value="<?php if($subscription->package_id){
    echo $subscription->package_id;
}?>">
									</div>
								</div>
								<div class="col-md-3 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Enter Coins Offered</label>
										<input type="number" id="coins_offered" name="coins_offered" class="form-control mdl-textfield__input"  placeholder="<?php echo $subscription->coins_offered;?>" value="<?php echo $subscription->coins_offered;?>">

									</div>
								</div>
								<div class="col-md-3 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Enter Button Name on Enable</label>
										<input type="text" id="btn_on_enable" name="btn_on_enable" class="form-control mdl-textfield__input"  placeholder="<?php echo $subscription->btn_on_enable;?>" value="<?php echo $subscription->btn_on_enable;?>">

									</div>
								</div>
								<div class="col-md-3 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Enter Button Name on Disable</label>
										<input type="text" id="btn_on_disable" name="btn_on_disable" class="form-control mdl-textfield__input"  placeholder="<?php echo $subscription->btn_on_disable;?>" value="<?php echo $subscription->btn_on_disable;?>">
								...
								<div class="col-md-4 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<input type="text"  name="content" class="form-control mdl-textfield__input"  placeholder="<?php echo $subscription->content;?>" value="<?php echo $subscription->content;?>">
									</div>
								</div>
								...
								<div class="col-md-4 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<img src="<?php echo URLROOT?>/uploads/<?php echo $subscription->image;?>" style="width:20%;height:20%;">
									</div>
								</div>
								<?php } ?>
								<div class="col-md-3 col-sm-3">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<option value="1" <?php if($subscription->status=="1"){ echo "selected";}?>>Enable</option>
												<option value="0" <?php if($subscription->status=="0"){ echo "selected";}?>>Disable</option>
