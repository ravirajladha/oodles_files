		...
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				...
				<ol class="breadcrumb page-breadcrumb pull-right">
					...
					<li><a class="parent-item" href="<?php echo URLROOT; ?>/admin/add_faq">FAQ</a>&nbsp;<i class="fa fa-angle-right"></i>
					</li>
		...
		<div class="row">
			<div class=" col-sm-12">
				<div class="card-box">
					...
					<form method="post" action="<?php echo URLROOT; ?>/admin/update_faq/<?php echo $faq_id; ?>" enctype="multipart/form-data" autocomplete="OFF">
							...
							<div class="card-body row">
								...
								<div class="col-md-12 col-sm-12">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<input type="text" value="<?php echo $faq_info->question; ?>" name="question" class="form-control mdl-textfield__input" placeholder="Enter Question" required>
								...
								<div class="col-md-12 col-sm-12">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Answer</label>
										<input type="text" id="price" value="<?php echo $faq_info->answer; ?>" name="answer" class="form-control mdl-textfield__input" placeholder="Enter Answer">
									</div>
								</div>
