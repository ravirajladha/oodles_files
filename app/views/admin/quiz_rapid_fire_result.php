		...
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				...
				<ol class="breadcrumb page-breadcrumb pull-right">
					...
					<li><a class="parent-item" href="<?php echo URLROOT; ?>/admin/quizes/3/0">Quizes</a>&nbsp;<i class="fa fa-angle-right"></i>
					</li>
				...
				<div class="panel tab-border card-box">
					<header class="panel-heading panel-heading-gray custom-tab ">
						<ul class="nav nav-tabs">
							<li class="nav-item"><a href="#profile"   class="active" data-bs-toggle="tab">Rapid Fire</a>
							</li>
						</ul>
					</header>
