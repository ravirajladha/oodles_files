							...
							<div class="col-md-6 col-sm-6">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<?php if ($detail->website_check == 1) { ?>
										<input type="checkbox"  name="website_check" value="1" checked><br>
									<?php } else { ?>
										<input type="checkbox" name="website_check" value="0"><br>
									<?php	} ?>
							...
							<div class="col-md-6 col-sm-6">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<select name="accredited_by" class="form-control">
											...
											<option value="1" 	<?php if ($detail->accredited_by == 1) { echo "selected"; } ?>>A</option>
											<option value="2" <?php if ($detail->accredited_by == 2) { echo "selected"; } ?>>B</option>
											<option value="3" <?php if ($detail->accredited_by == 3) { echo "selected"; } ?>>C</option>
									</select>
								</div>
							</div>
