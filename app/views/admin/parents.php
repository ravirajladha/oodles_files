									...
									<div class="card card-box">
										...
										<div class="card-body ">
											...
											<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
												...
												<tbody>
													<?php foreach ($data['get_all_parents'] as $parent) { ?>
														<tr class="odd gradeX">
															...
															<td class="left"><?php echo $parent->id ?></td>
															<td>
																<?php
																$parent_id = 	$parent->id;
																$adminMod = new Admins;
																$get_parent_detail = $adminMod->get_individual_parent($parent_id);

																if(isset($get_parent_detail->student_id)) {


																?>
																	<a href="<?php echo URLROOT ?>/admin/student/<?php echo $parent->id ?>"><?php echo $parent->name ?> </a>
																<?php } else { ?>
															...
															<td class="left"><?php echo $parent->email ?></td>
															<td><a href="#">
																	<?php echo $parent->phone ?> </a></td>
													...
													<!-- <tr class="odd gradeX">
																	...
																	<td>
																		<a href="edit_parent.html" class="tblEditBtn">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a class="tblDelBtn">
																			<i class="fa fa-trash-o"></i>
										...
										<div class="card card-box">
											...
											<div class="card-body no-padding ">
												...
												<div class="doctor-profile">
													<!-- <img src="<?php echo URLROOT ?>/uploads/<?php echo $parent->image ?>" class="doctor-pic"
																alt=""> -->
													<i class="fa fa-graduation-cap"></i>
													<div class="profile-usertitle">
														<div class="doctor-name"><?php echo $parent->name ?> </div>
														<div class="name-center"> <?php echo $parent->email ?> </div>
													</div>

													<div>
														<p><i class="fa fa-phone"></i><a href="tel:<?php echo $parent->phone ?>"> <?php echo $parent->phone ?></a></p>
													</div>
													<div class="profile-userbuttons">
														<!-- <a href="<?php echo URLROOT; ?>/admin/parent/<?php echo $parent->id ?>"
