		...
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				...
				<ol class="breadcrumb page-breadcrumb pull-right">
					...
					<li><a class="parent-item" href="<?php echo URLROOT; ?>/admin/quizes/1/0">Quizes</a>&nbsp;<i class="fa fa-angle-right"></i>
					</li>
									...
									<tbody>
										...
										<?php foreach ($quiz_practice as $quiz) { ?>
											<tr class="odd gradeX">
												...
												<td>
													<a href="<?php echo URLROOT ?>/admin/quiz_practice_report/<?php echo $quiz->id; ?>" target="_blank"><button class="form-control"> View</button> </a>
