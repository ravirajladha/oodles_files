	...
	<div class="page-content">
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				<div class=" pull-left">
					<div class="page-title">All guardians List</div>
				</div>
				<ol class="breadcrumb page-breadcrumb pull-right">
					<li><i class="fa fa-home"></i>&nbsp;<a class="guardian-item" href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
					</li>
					<li><a class="guardian-item" href="">guardians</a>&nbsp;<i class="fa fa-angle-right"></i>
					</li>
					<li class="active">All guardians List</li>
				</ol>
			</div>
		</div>
		<div class="row">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="card card-box">
										<div class="card-head">
											<header>All Guardians List</header>
											<div class="tools">
										...
										<div class="card-body ">
											...
											<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
												...
												<tbody>
													<?php foreach ($data['get_all_guardians'] as $guardian) { ?>
														<tr class="odd gradeX">
															...
															<td class="left"><?php echo $guardian->id ?></td>
															<td>
																<?php
																$guardian_id = 	$guardian->id;
																$adminMod = new Admins;
																$get_guardian_detail = $adminMod->get_individual_guardian($guardian_id);

																if(isset($get_guardian_detail->student_id)) {


																?>
																	<a href="<?php echo URLROOT ?>/admin/student/<?php echo $guardian->id ?>"><?php echo $guardian->name ?> </a>
																<?php } else { ?>
															...
															<td class="left"><?php echo $guardian->email ?></td>
															<td><a href="#">
																	<?php echo $guardian->phone ?> </a></td>
										...
										<div class="card card-box">
											...
											<div class="card-body no-padding ">
												...
												<div class="doctor-profile">
													<!-- <img src="<?php echo URLROOT ?>/uploads/<?php echo $guardian->image ?>" class="doctor-pic"
																alt=""> -->
													<i class="fa fa-graduation-cap"></i>
													<div class="profile-usertitle">
														<div class="doctor-name"><?php echo $guardian->name ?> </div>
														<div class="name-center"> <?php echo $guardian->email ?> </div>
													</div>

													<div>
														<p><i class="fa fa-phone"></i><a href="tel:<?php echo $guardian->phone ?>"> <?php echo $guardian->phone ?></a></p>
													</div>
													<div class="profile-userbuttons">
														<!-- <a href="<?php echo URLROOT; ?>/admin/guardian/<?php echo $guardian->id ?>"
