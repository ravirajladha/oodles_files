		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card-box">
					...
					<form method="post" action="<?php echo URLROOT; ?>/admin/create_document" enctype="multipart/form-data">
...
<br>
							...
							<div class="col-lg-4 p-t-20">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
									...
									<br>
									<input class="mdl-textfield__input" type="date" id="txtTimeLength" name="expiry_date" required>
														...
														<tbody>
															<?php foreach ($data['get_all_document'] as $document) { ?>
																<tr class="odd gradeX">
																	...
																	<?php } else { ?>
																		<td><a href="<?php echo URLROOT; ?>/admin/update_document_status/<?php echo $document->id ?>/0"><button type="button" class="btn btn-primary">Inactive</button></a></td>
																	<?php } ?>
