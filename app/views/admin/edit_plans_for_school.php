...
<?php $subscription = $data['get_school_plan']; ?>
  <!--select2-->
	...
	<div class="page-content">
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				<div class=" pull-left">
					<div class="page-title">Edit School Plan</div>
				</div>
				<ol class="breadcrumb page-breadcrumb pull-right">
					...
					<li class="active">Add School Plan</li>
				</ol>
			</div>
		</div>
		...
		<div class="row">
			<div class=" col-sm-12">
				<div class="card-box">
					...
					<form method="post" action="<?php echo URLROOT; ?>/admin/update_subscription_plans_for_school/<?php echo $subscription->id;?>" enctype="multipart/form-data" autocomplete="OFF">
							...
							<div class="card-body row">
								...
								<div class="col-md-3 col-sm-3">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Name</label>
										<input type="text" id="name" name="name" class="form-control mdl-textfield__input" placeholder="Enter Name" value="<?php echo $subscription->name;?>" required>
								...
								<div class="col-md-3 col-sm-3">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<input type="number" id="no_of_teacher" name="no_of_teacher" class="form-control mdl-textfield__input" placeholder="Enter Number of Teacher" value="<?php echo $subscription->no_of_teacher;?>">
									</div>
								</div>
								<div class="col-md-3 col-sm-3">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Enter Number of Quiz</label>
										<input type="number" id="offer_price" name="no_of_quiz"  class="form-control mdl-textfield__input" placeholder="Enter Number of Quiz" value="<?php echo $subscription->no_of_quiz;?>">
									</div>
								</div>
								...
								<div class="col-md-3 col-sm-3">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<option value="1" <?php if($subscription->status==1){echo "selected";}?>>Enable</option>
												<option value="0" <?php if($subscription->status==0
