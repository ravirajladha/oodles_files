										...
										<div class="card-body ">
											...
											<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
												...
												<tbody>
													...
													<form action="<?php echo URLROOT; ?>/admin/delete_home_enquiry" method="POST">
													<button type="submit" class="btn btn-primary" style="float:right;">Delete</button>
													<?php foreach ($data['get_all_home_enquiry'] as $enquiry) { ?>
														<tr class="odd gradeX">
															...
															<td class="left"><?php echo $enquiry->email?></td>
															<td class="left"><?php echo $enquiry->phone?></td>
															
															<td class="left"><?php echo $enquiry->subject?></td>
															<td class="left"><?php echo $enquiry->message?></td>
