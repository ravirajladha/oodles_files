			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form" style="margin-top:50px">
						...
						<form method="post" action="<?php echo URLROOT; ?>/admin/login" autocomplete="off" class="register-form">

							<p style="text-align:center;font-size:24px;">Admin Login</p>
							<br>
							<div class="form-group">
								<div class="">
									<input type="text" name="username" placeholder="Your Email/Phone Number" class="form-control input-height" />
								</div>
							</div>
							<div class="form-group">
								<div class="">
