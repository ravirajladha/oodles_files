...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="row">
            ...
            <a href="<?php echo URLROOT ?>/admin/edit_prize_after_registration/<?php echo  $get_quiz_detail->id; ?>"><button class="btn blue-bgcolor btn-outline btn-circle m-b-10"><i class="fa-solid fa-pencil"></i> Edit</button></a>
            </div> -->
                                        ...
                                        foreach ($prize_data as $level) {
                                            ...
                                            if ($current_timestamp  < $ten_minutes_before) {
                                                ...
                                                if ($prize_pool_calculation->no_of_participants != $count_of_quiz_registration) {
                                                    // added by ashutosh-- if no of registered students is equal to the sum of winners of every level then break the loop
                                                    // $no_of_winners_percentage = $prize_pool_calculation->no_of_winners_percentage;
                                                    // $actual_winners = intval(($count_of_quiz_registration*$no_of_winners_percentage)/100);
                                                    // if($end > $actual_winners){
                                                    //     break;
                                                    // }
