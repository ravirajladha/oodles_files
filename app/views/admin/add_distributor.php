            ...
            <div class="container-fluid">
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Add Distributors</a></li>
					</ol>
                </div>
				
                <div class="row">
                <?php foreach($data['get_all_distributor'] as $distributor){ ?>
                    <div class="col-xl-4 col-lg-6">
								<div class="card shadow_1">
									<div class="card-body">	
										<div class="media mb-2">
											<div class="media-body">
												<p class="mb-1"><?php echo $distributor->name; ?></p>
												<h4 class="fs-20 text-black"><?php echo $distributor->phone; ?></h4>
											</div>
                                            <img class="img-fluid" width="60" height="60" src="<?php echo URLROOT?>/assets_admin/images/user.jpg" alt="">
											<!-- <svg class="ms-3" width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="<?php echo URLROOT?>/assets_admin/images/user.jpg"> -->
										...
										<span class="text-primary font-w500 d-block mb-3">Distributor ID: <span><?php echo $distributor->id; ?></span></span>
										<!-- <p class="fs-14"> <span><?php echo $distributor->created_at; ?></span></p> -->
										<div class="d-flex align-items-center mt-4">
											<a href="<?php echo URLROOT?>/admin/add_distributor/<?php echo $distributor->id;?>" class="btn btn-primary light btn-rounded me-auto">View Profile</a>
											<?php if($distributor->status==0){ ?>
												<a href="<?php echo URLROOT?>/admin/update_status_in_auth/<?php echo $distributor->id;?>/1" class="btn btn-primary light btn-rounded me-auto">Activate</a>
											<?php }else{ ?>
												<a href="<?php echo URLROOT?>/admin/update_status_in_auth/<?php echo $distributor->id;?>/0" class="btn btn-primary light btn-rounded me-auto">Deactivate</a>
												<?php } ?>
