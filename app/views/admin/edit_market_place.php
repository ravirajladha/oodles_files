...
<?php  $market_place = $data['get_single_market_place']; ?>
	...
	<div class="page-content">
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				<div class=" pull-left">
					<div class="page-title">Edit Market Place</div>
				</div>
				<ol class="breadcrumb page-breadcrumb pull-right">
					...
					<li><a class="parent-item" href="<?php echo URLROOT; ?>/admin/add_market_place">Add Market Place</a>&nbsp;<i class="fa fa-angle-right"></i></li>
					<li class="active">Edit Market Place</li>
				</ol>
			</div>
		</div>
		...
		<div class="row">
			<div class=" col-sm-12">
				<div class="card-box">
					...
					<form method="post" action="<?php echo URLROOT; ?>/admin/update_market_place/<?php echo $data['id']; ?>" enctype="multipart/form-data" autocomplete="OFF">
							...
							<div class="card-body row">
								...
								<div class="col-md-4 col-sm-4">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Name</label>
										<input type="text" id="name" name="name" value="<?php echo $market_place->name; ?>" class="form-control mdl-textfield__input" placeholder="Enter Name" required>

									</div>
								</div>
								<div class="col-md-4 col-sm-4">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Offer Price (in coins)</label>
										<input type="number" id="offer_price" name="offer_price" value="<?php echo $market_place->offer_price; ?>" class="form-control mdl-textfield__input" placeholder="Enter Offer Price">
									</div>
								</div>
								<div class="col-md-4 col-sm-4">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Price (in coins)</label>
										<input type="number" id="price" name="price" value="<?php echo $market_place->price; ?>" class="form-control mdl-textfield__input" placeholder="Enter Price">
									</div>
								</div>
								<div class="col-md-6 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Quantity</label>
										<input type="number" id="price" name="quantity" value="<?php echo $market_place->quantity; ?>" class="form-control mdl-textfield__input" placeholder="Enter Quantity">
									</div>
								</div>
								...
								<div class="col-md-6 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Choose  Photo<span>*</span> <a href="<?php echo URLROOT; ?>/uploads/<?php echo $market_place->image; ?>"><i class="fa fa-image"></i></a></label><br>
								...
								<div class="col-md-6 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<textarea  name="description" class="form-control mdl-textfield__input"  placeholder="Enter Content for Description"><?php echo $market_place->description; ?></textarea>
									</div>
								</div>
