...
<div class="page-content-wrapper">
	<div class="page-content">
		...
		<?php 
		 $data['get_quiz_id'] ?>
		<form method="POST" action="<?php echo URLROOT; ?>/admin/create_question_while_quiz/<?php echo $data['get_quiz_id']?>" enctype="multipart/form-data" autocomplete="OFF">
			<div class="row">
				<div class=" col-sm-12">
					<div class="card-box">
						<div class="card-head">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-lg-6">
						<button type="submit" class="btn btn-primary" style="float: right;" id="submit" name="single_question"  value="single">Submit</button>
					</div>
					<!-- <div class="col-lg-6 col-lg-6">
