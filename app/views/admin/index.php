							...
							<div class="col-xl-3 col-md-6 col-12">
								<div class="info-box bg-b-green">
									...
									<div class="info-box-content">
										...
										<span class="info-box-number"><?php echo $count_of_students; ?></span>
										<div class="progress">
							...
							<div class="col-xl-3 col-md-6 col-12">
								<div class="info-box bg-b-yellow">
									...
									<div class="info-box-content">
										...
										<span class="info-box-number"><?php echo $count_of_scholarship; ?></span>
										<div class="progress">
							...
							<div class="col-xl-3 col-md-6 col-12">
								<div class="info-box bg-b-blue">
									...
									<div class="info-box-content">
										...
										<span class="info-box-number"><?php echo $count_of_quizes; ?></span>
										<div class="progress">
							...
							<div class="col-xl-3 col-md-6 col-12">
								<div class="info-box bg-b-pink">
									...
									<div class="info-box-content">
										...
										<span><i class="fa fa-inr"></i></span> <span class="info-box-number">100</span>
										<div class="progress">
