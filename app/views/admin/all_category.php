				...
				<div class="col-md-12">
					<ul id="tree1">
						...
						<?php foreach ($data['get_all_class'] as $class) { ?>
							<li>ID: <?php echo $class->id; ?>)&ensp;<a href="<?php echo URLROOT ?>/admin/edit_class/<?php echo $class->id; ?>"><?php echo $class->class_name; ?></a>
							<?php $get_all_subject = $adminMod->get_subject_through_class($class->id); ?>
								
									<ul>
									<?php  foreach ($get_all_subject as $get_subject) { ?>
										<li>ID: <?php echo $get_subject->id; ?>)&ensp;<a href="<?php echo URLROOT ?>/admin/edit_subject/<?php echo $subject->id; ?>"><?php echo $get_subject->subject_name; ?></a>
											<?php $get_all_chapter = $adminMod->get_sub_subject_from_subject($get_subject->id); ?>

											<ul>
												<?php foreach ($get_all_chapter as $get_chapter) {  ?>
													<li>ID: <a href="<?php echo URLROOT ?>/admin/edit_chapter/<?php echo $chapter->id; ?>"><?php echo $get_chapter->id; ?>)&ensp;<?php echo  $get_chapter->name; ?></a>
														<?php $get_all_topic = $adminMod->get_topic_from_chapter($get_chapter->id); ?>

														<ul>
															<?php foreach ($get_all_topic as $get_topic) { ?>
																<li>ID: <a href="<?php echo URLROOT ?>/admin/edit_topic/<?php echo $topic->id; ?>"><?php echo $get_topic->id; ?>)&ensp;<?php echo $get_topic->name; ?></a></li>
...
<script>
	$.fn.extend({
		treed: function(o) {
			...
			var openedClass = 'fa fa-chevron-up';
			var closedClass = 'fa fa-chevron-down';
