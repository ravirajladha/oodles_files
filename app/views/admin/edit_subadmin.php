...
$subadmin = $data['get_single_subadmin'];
?>
<!-- start page content -->
	...
	<div class="page-content">
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				<div class=" pull-left">
					<div class="page-title">Edit Subadmin</div>
				</div>
		...
		<form action="<?php echo URLROOT; ?>/admin/update_subadmin/<?php echo $subadmin->id; ?>" method="post" enctype="multipart/form-data">
			<div class="row">
				<div class=" col-sm-12">
						...
						<div class="card-body row">
							...
							<div class="col-md-4 col-sm-6">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<input class="form-control mdl-textfield__input" type="text" name="auth_name" placeholder="Enter Name" value="<?php echo $subadmin->name; ?>">
								</div>
							</div>
							...
							<div class="col-md-4 col-sm-6">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<input class="form-control mdl-textfield__input" type="email" id="txtPwd" name="auth_email" placeholder="Enter Email ID" required value="<?php echo $subadmin->email; ?>">
								</div>
							</div>
							<div class="col-md-4 col-sm-6">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									<label>Enter Password<span>*</span></label><br>
									<input class="form-control mdl-textfield__input" type="password" id="txtPwd" name="password" placeholder="Feel free to leave the password field blank if you do not wish to make any changes." >
								</div>
							</div>
							...
							<div class="col-md-4 col-sm-9">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<input class="form-control mdl-textfield__input" type="number" id="auth_contact_number" name="auth_contact_number" placeholder="Enter Contact Number" required oninput="numberOnly(this.id);" maxlength="10" value="<?php echo $subadmin->phone; ?>">
								</div>
							</div>
							...
							<div class="col-md-4 col-sm-4">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<select class="form-control mdl-textfield__input" name="type" placeholder="Enter First Contact Person Name">
										<option readonly>--Select--</option>
										<option value="1" <?php if ($subadmin->type == "subadmin_quiz") {
																echo "selected";
															} ?>>Quiz</option>
										<option value="2" <?php if ($subadmin->type == "subadmin_scholarship") {
																echo "selected";
															} ?>>Scholarship</option>
									</select>
								</div>
							...
							<div class="col-md-4 col-sm-4">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<label>Choose Photo<span>*	<?php if (!empty($subadmin->image)){ ?>
										<a href="<?php echo URLROOT; ?>/uploads/<?php echo $subadmin->image; ?>" target="_blank">(View Image)</a>
										<?php } ?></span></label><br>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-lg-6">
					<button type="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-circle btn-primary">Save</button>
						<a href="<?php echo URLROOT; ?>/admin/add_subadmin">	<button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-circle btn-dark">View all</button></a>
					</div>
