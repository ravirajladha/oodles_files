...
<?php 
$assigned_plan = $data['get_selected_school_plan'];
?>
					<form method="post" action="<?php echo URLROOT; ?>/admin/edit_assigned_subscription_plans_to_school" enctype="multipart/form-data" autocomplete="OFF">
						...
						<div class="card-body row">
								...
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<select class="form-control" name="plan">
										<?php foreach ($data['get_school_plan'] as $plan) { ?>
											<option value="<?php echo $plan->id; ?>" <?php if($assigned_plan->plan==$plan->id){echo "selected";} ?>><?php echo $plan->name; ?></option>
										<?php } ?>
									</select>
								...
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<select class="form-control" name="school" disabled>
										<?php foreach ($data['get_school_detail'] as $school) { ?>
											<option value="<?php echo $school->school_id; ?>" <?php if($assigned_plan->school==$school->school_id){echo "selected";} ?>><?php echo $school->school_name; ?></option>
										<?php } ?>
									</select>
							...
							<div class="col-md-4 col-sm-3">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<input type="date" id="start_date" name="start_date" value="<?php echo $assigned_plan->start_date; ?>" class="form-control mdl-textfield__input" required>
								</div>
							</div>
							<div class="col-md-4 col-sm-3">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									<label>End Date</label>
									<input type="date" id="end_date" name="end_date" value="<?php echo $assigned_plan->end_date; ?>" class="form-control mdl-textfield__input" required>
								</div>
							</div>
							<div class="col-md-4 col-sm-3">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									<label>Amount Collected</label>
									<input type="number" id="offer_price" name="amount" class="form-control mdl-textfield__input" placeholder="Enter Amount to be collected from school" value="<?php echo $assigned_plan->amount; ?>" required>
								</div>
							</div>
							...
							<div class="col-md-4 col-sm-3">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<select name="status" class="form-control" required>
										...
										<option value="1" <?php if($assigned_plan->status=='1'){echo "selected";} ?>>Enable</option>
										<option value="0" <?php if($assigned_plan->status=='0'){echo "selected";} ?>>Disable</option>
