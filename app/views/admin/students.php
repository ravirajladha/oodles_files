									...
									<div class="card card-box">
										<div class="card-head">
											...
											<div class="">
												...
												<form method="get" action="<?php echo URLROOT; ?>/admin/students_search" enctype="multipart/form-data" autocomplete="OFF">
													<div class="row">
														<div class="col-md-8">
															<input class="form-control text-center" type="text" placeholder="Search Name" name="search_input">
														</div>
														<div class="col-md-4">
															<button type="submit" class="btn btn-primary"><i class="fas fa-filter"></i>&nbsp;Filter</button>
														</div>
													</div>
													<!-- Give mobile number or name:
                             <select name="school_type" class="form-control">
                         <option value="0">Select All</option>
                         <option value="1">Private</option>
                         <option value="2">Government</option>
                         <option value="3">Government Aided</option>
												...
												<tbody>
													<?php foreach ($data['get_all_students'] as $student) { ?>
														<tr class="odd gradeX">
															...
															<td class="left"><?php echo $student->id ?></td>
															<td>

																<?php
																$student_id = 	$student->id;
																$adminMod = new Admins;
																$get_student_detail = $adminMod->get_individual_student($student_id);

																if (isset($get_student_detail->student_id)) {


																?>
																	<a href="<?php echo URLROOT ?>/admin/student/<?php echo $student->id ?>"><?php echo $student->name ?> </a>
																<?php } else { ?>
															...
															<td><a href="#">
																	<?php echo $student->phone ?> </a></td>


															<td>
																<a href="<?php echo URLROOT ?>/admin/update_student_profile/<?php echo $student->id ?>" class="tblEditBtn">
																	<i class="fa fa-pencil"></i>
																</a>
																<a class="tblDelBtn" href="<?php echo URLROOT ?>/admin/delete_student/<?php echo $student->id; ?>">
											...
											<div class="card-body no-padding ">
												...
												<div class="doctor-profile">
													...
													<div class="profile-usertitle">
														<div class="doctor-name"><?php echo $student->name ?> </div>
														<div class="name-center"> <?php echo $student->email ?> </div>
													</div>

													<div>
														<p><i class="fa fa-phone"></i><a href="tel:<?php echo $student->phone ?>"> <?php echo $student->phone ?></a></p>
													</div>
													<!-- <div class="profile-userbuttons">
																...
																if (isset($get_student_detail->student_id)) {
																?>
																		 <a href="<?php echo URLROOT; ?>/admin/student/<?php echo $student->id ?>"
