					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								...
								<form method="post" action="<?php echo URLROOT; ?>/admin/create_boards" enctype="multipart/form-data">
								<div class="card-body row">
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<label class="mdl-textfield__label">Add Board Name</label><br>
												...
												<tbody>
													<?php foreach ($data['get_all_boards'] as $boards) { ?>
														<tr class="odd gradeX">
															...
															<td class="left"><?php echo $boards->id ?></td>
															
															<td class="left"><?php echo $boards->name?></td>
												
															
															<td>
																 <a href="<?php echo URLROOT?>/admin/edit_boards/<?php echo $boards->id?>" class="tblEditBtn"> 
