					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								...
								<form method="post" action="<?php echo URLROOT; ?>/admin/create_teacher" enctype="multipart/form-data">
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<label class="mdl-textfield__label">School</label><br>
											<select class="mdl-textfield__input" name="school">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="number"  name="phone" required>
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
...
echo $get_school_detail->school_name;
															...
															<td>
																...
																<!-- <a class="tblDelBtn">
																	...
																	<form action="<?php echo URLROOT?>/admin/change_teacher_status/<?php echo $teacher->id ?>" method="POST">
