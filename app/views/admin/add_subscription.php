		...
		<div class="row">
			<div class=" col-sm-12">
				<div class="card-box">
					...
					<form method="post" action="<?php echo URLROOT; ?>/admin/add_subscription_elements" enctype="multipart/form-data" autocomplete="OFF">
							...
							<div class="card-body row">
								...
								<div class="col-md-3 col-sm-3">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Price</label>
										<input type="number" id="price" name="price" class="form-control mdl-textfield__input" placeholder="Enter Price">
									</div>
								</div>
								<div class="col-md-3 col-sm-3">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Offer Price</label>
										<input type="number" id="offer_price" name="offer_price" class="form-control mdl-textfield__input" placeholder="Enter Offer Price">
									</div>
								</div>
								<div class="col-md-3 col-sm-3">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<div class="col-md-3 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<input type="number" id="package_id" name="package_id" class="form-control mdl-textfield__input" placeholder="Enter Package Id">
									</div>
								</div>
								<div class="col-md-3 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Enter Coins Offered</label>
										<input type="number" id="coins_offered" name="coins_offered" class="form-control mdl-textfield__input" placeholder="Enter Coins">
								...
								<div class="col-md-3 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<input type="text" id="btn_on_enable" name="btn_on_enable" class="form-control mdl-textfield__input" placeholder="Enter Button Name on Enable">
								...
								<div class="col-md-3 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<input type="text" id="btn_on_disable" name="btn_on_disable" class="form-control mdl-textfield__input" placeholder="Enter Button Name on Disable">
								...
								<div class="col-md-4 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<input type="text"  name="content" class="form-control mdl-textfield__input" placeholder="Enter Content for Subscription">
									</div>
								</div>
								<div class="col-md-3 col-sm-3">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
