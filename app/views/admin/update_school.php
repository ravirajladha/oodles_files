	...
	<div class="page-content">
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				<div class=" pull-left">
					<div class="page-title">Update School</div>
				</div>
		...
		<div class="row">
			...
			<div class=" col-sm-12">
				...
				<div class="card-box">
					...
					<form method="post" action="<?php echo URLROOT; ?>/admin/update_school_elements/<?php echo $detail->id?>" enctype="multipart/form-data" autocomplete="OFF">
						...
						<div class="card-body row">
							...
							<div class="col-md-4 col-sm-6">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<input type="text" name="school_name" class="form-control mdl-textfield__input" placeholder="<?php echo $detail->school_name; ?>" value="<?php echo $detail->school_name; ?>">

								</div>
							</div>
							<div class="col-md-4 col-sm-6">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									<?php if (!empty($detail->school_image)) { ?>
										<label>Update School Photo<span>*</span></label>
										<a href="<?php echo URLROOT ?>/uploads/<?php echo $detail->school_image ?>" id="blah" target="_blank"><i class='fa-solid fa-eye'></i></a><br>
									<?php } else { ?>
										<label>Upload School Photo<span>*</span></label><br>
									<?php } ?>
									<input class="form-control mdl-textfield__input" type="file" id="maxStu" name="school_image">
							...
							<div class="col-md-4 col-sm-6">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<input class="form-control mdl-textfield__input" type="text" id="maxStu" name="school_contact_no" placeholder="<?php echo $detail->school_contact_no; ?>" value="<?php echo $detail->school_contact_no; ?>">
							...
							<div class="col-md-3 col-sm-6">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<input type="text" id="branch_address" name="school_address" class=" form-control mdl-textfield__input" placeholder="<?php echo $detail->school_address; ?>" value="<?php echo $detail->school_address; ?>">
							...
							<div class="col-md-3 col-sm-6">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<input class="form-control mdl-textfield__input" type="text" name="school_pin_code" placeholder="<?php echo $detail->school_pin_code; ?>" value="<?php echo $detail->school_pin_code; ?>">
							...
							<div class="col-md-3 col-sm-6">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<input class="form-control mdl-textfield__input" type="text" name="school_city" placeholder="<?php echo $detail->school_city; ?>" value="<?php echo $detail->school_city; ?>">
							...
							<div class="col-md-3 col-sm-6">
								...
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<select name="school_state" class="form-control">
										<?php $school_state = $detail->school_state; ?>

										<option value="Andhra Pradesh" <?php if ($school_state == "Andhra Pradesh") {
																			echo "selected";
																		} ?>>Andhra Pradesh</option>
										<option value="Andaman and Nicobar Islands" <?php if ($school_state == "Andaman and Nicobar Islands") {
																						echo "selected";
																					} ?>>Andaman and Nicobar Islands</option>
										<option value="Arunachal Pradesh" <?php if ($school_state == "Arunachal Pradesh") {
																				echo "selected";
																			} ?>>Arunachal Pradesh</option>
										<option value="Assam" <?php if ($school_state == "Assam") {
																	echo "selected";
																} ?>>Assam</option>
										<option value="Bihar" <?php if ($school_state == "Bihar") {
																	echo "selected";
																} ?>>Bihar</option>
										<option value="Chandigarh" <?php if ($school_state == "Chandigarh") {
																		echo "selected";
																	} ?>>Chandigarh</option>
										<option value="Chhattisgarh" <?php if ($school_state == "Chhattisgarh") {
																			echo "selected";
																		} ?>>Chhattisgarh</option>
										<option value="Dadar and Nagar Haveli" <?php if ($school_state == "Dadar and Nagar Haveli") {
																					echo "selected";
																				} ?>>Dadar and Nagar Haveli</option>
										<option value="Daman and Diu" <?php if ($school_state == "Daman and Diu") {
																			echo "selected";
																		} ?>>Daman and Diu</option>
										<option value="Delhi" <?php if ($school_state == "Delhi") {
																	echo "selected";
																} ?>>Delhi</option>
										<option value="Lakshadweep" <?php if ($school_state == "Lakshadweep") {
																		echo "selected";
																	} ?>>Lakshadweep</option>
										<option value="Puducherry" <?php if ($school_state == "Puducherry") {
																		echo "selected";
																	} ?>>Puducherry</option>
										<option value="Goa" <?php if ($school_state == "Goa") {
																echo "selected";
															} ?>>Goa</option>
										<option value="Gujarat" <?php if ($school_state == "Gujarat") {
																	echo "selected";
																} ?>>Gujarat</option>
										<option value="Haryana" <?php if ($school_state == "Haryana") {
																	echo "selected";
																} ?>>Haryana</option>
										<option value="Himachal Pradesh" <?php if ($school_state == "Himachal Pradesh") {
																				echo "selected";
																			} ?>>Himachal Pradesh</option>
										<option value="Jammu and Kashmir" <?php if ($school_state == "Jammu and Kashmir") {
																				echo "selected";
																			} ?>>Jammu and Kashmir</option>
										<option value="Jharkhand" <?php if ($school_state == "Jharkhand") {
																		echo "selected";
																	} ?>>Jharkhand</option>
										<option value="Karnataka" <?php if ($school_state == "Karnataka") {
																		echo "selected";
																	} ?>>Karnataka</option>
										<option value="Kerala" <?php if ($school_state == "Kerala") {
																	echo "selected";
																} ?>>Kerala</option>
										<option value="Madhya Pradesh" <?php if ($school_state == "Madhya Pradesh") {
																			echo "selected";
																		} ?>>Madhya Pradesh</option>
										<option value="Maharashtra" <?php if ($school_state == "Maharashtra") {
																		echo "selected";
																	} ?>>Maharashtra</option>
										<option value="Manipur" <?php if ($school_state == "Manipur") {
																	echo "selected";
																} ?>>Manipur</option>
										<option value="Meghalaya" <?php if ($school_state == "Meghalaya") {
																		echo "selected";
																	} ?>>Meghalaya</option>
										<option value="Mizoram" <?php if ($school_state == "Mizoram") {
																	echo "selected";
																} ?>>Mizoram</option>
										<option value="Nagaland" <?php if ($school_state == "Nagaland") {
																		echo "selected";
																	} ?>>Nagaland</option>
										<option value="Odisha" <?php if ($school_state == "Odisha") {
																	echo "selected";
																} ?>>Odisha</option>
										<option value="Punjab" <?php if ($school_state == "Punjab") {
																	echo "selected";
																} ?>>Punjab</option>
										<option value="Rajasthan" <?php if ($school_state == "Rajasthan") {
																		echo "selected";
																	} ?>>Rajasthan</option>
										<option value="Sikkim" <?php if ($school_state == "Sikkim") {
																	echo "selected";
																} ?>>Sikkim</option>
										<option value="Tamil Nadu" <?php if ($school_state == "Tamil Nadu") {
																		echo "selected";
																	} ?>>Tamil Nadu</option>
										<option value="Telangana" <?php if ($school_state == "Telangana") {
																		echo "selected";
																	} ?>>Telangana</option>
										<option value="Tripura" <?php if ($school_state == "Tripura") {
																	echo "selected";
																} ?>>Tripura</option>
										<option value="Uttar Pradesh" <?php if ($school_state == "Uttar Pradesh") {
																			echo "selected";
																		} ?>>Uttar Pradesh</option>
										<option value="Uttarakhand" <?php if ($school_state == "Uttarakhand") {
																		echo "selected";
																	} ?>>Uttarakhand</option>
										<option value="West Bengal" <?php if ($school_state == "West Bengal") {
																		echo "selected";
																	} ?>>West Bengal</option>
									</select>
							...
							<div class="col-md-6 col-sm-6">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<input class="form-control mdl-textfield__input" type="number" min="1900" max="2025" step="1" value="2022" name="year_of_establishment" placeholder="<?php echo $detail->year_of_establishment; ?>" value="<?php echo $detail->year_of_establishment; ?>">
								</div>
							</div>
							<div class="col-md-6 col-sm-6">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<select name="school_type" class="form-control">
										<?php $school_type = $detail->school_type; ?>
										<option value="">-Select Type-</option>
										<option value="1" <?php if ($school_type == "1") {
																echo "selected";
															} ?>>Private</option>
										<option value="2" <?php if ($school_type == "2") {
																echo "selected";
															} ?>>Government</option>
										<option value="3" <?php if ($school_type == "3") {
																echo "selected";
															} ?>>Residential</option>
										<option value="4" <?php if ($school_type == "4") {
																echo "selected";
															} ?>>Boys</option>
										<option value="5" <?php if ($school_type == "5") {
																echo "selected";
															} ?>>Girls</option>
										<option value="6" <?php if ($school_type == "6") {
																echo "selected";
															} ?>>Co-ed</option>
									</select>
								</div>
							...
							<div class="col-md-6 col-sm-6">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<label>Website Link<span>*</span></label>&nbsp; <?php if ($detail->website_check == 1) { ?>
										<input type="checkbox" name="website_check" value="1" checked>
									<?php } else { ?>
										<input type="checkbox" name="website_check" value="0">
									<?php	} ?><br>
							...
							<div class="col-md-6 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label for="list2" class="">Category<span>*</span></label>
										<br>
										<select name="category" class="form-control" >
											<option value="" >-Select Type-</option>
											<option value="1" <?php if ($detail->category == 1){ echo "selected";}?> >Pre School</option>
											<option value="2" <?php if ($detail->category == 2){ echo "selected";}?>>Primary School</option>
											<option value="3" <?php if ($detail->category == 3){ echo "selected";}?>>Higher Secondary School</option>
										</select>
									</div>
								</div>
							...
							<div class="col-md-6 col-sm-6">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<input class="form-control mdl-textfield__input" type="text" name="accreditation_no" placeholder="<?php echo $detail->accreditation_no ?>" value="<?php echo $detail->accreditation_no ?>">
								</div>
							</div>
							...
							<div>
								...
								<label for="list2" class="">Recognized By<span>&nbsp;*
								</label>
									<select id="multiple" class="form-control select2-multiple" name="recognized_by[]" multiple>
										<optgroup label="-Select Type-">
											<option value="1" <?php if ($detail->accredited_by == 1) {
																	echo "selected";
																} ?>>A</option>
											<option value="2" <?php if ($detail->accredited_by == 2) {
																	echo "selected";
																} ?>>B</option>
											<option value="3" <?php if ($detail->accredited_by == 3) {
																	echo "selected";
																} ?>>C</option>
										</optgroup>
							...
							<div class="col-md-12 col-sm-6">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<br>
									<textarea id="oodles_editor1" rows="3" cols="60" name="school_info"><?php echo $detail->school_info ?></textarea>
					...
					<div class="card-body row">
						...
						<div class="col-md-12 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<br>
								<textarea id="oodles_editor2" rows="1" cols="10" name="admission_fee"><?php echo $detail->admission_fee ?></textarea>
							</div>
						</div>
					...
					<div class="card-body row">
						...
						<div class="col-md-12 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<br>
								<textarea id="oodles_editor3" rows="2" cols="60" name="how_to_apply"><?php echo $detail->how_to_apply ?></textarea>
							</div>
						</div>
					...
					<div class="card-body row">
						...
						<div class="col-md-12 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<select name="scholastic" class="form-control">
									<option value="" readonly>-Select Type-</option>
									<option value="1" <?php if ($detail->scholastic == 1) {
															echo "selected";
														} ?>>A</option>
									<option value="2" <?php if ($detail->scholastic == 2) {
															echo "selected";
														} ?>>B</option>
									<option value="3" <?php if ($detail->scholastic == 3) {
															echo "selected";
														} ?>>C</option>
								</select>
							</div>
						...
						<div class="col-md-12 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<br>
								<textarea id="oodles_editor4" rows="1" cols="12" name="scholastic_info"><?php echo $detail->scholastic_info ?></textarea>
							</div>
						</div>
					...
					<div class="card-body row">
						...
						<div class="col-md-12 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<select name="coscholastic" class="form-control">
									<option value="" readonly>-Select Type-</option>
									<option value="1" <?php if ($detail->coscholastic == 1) {
															echo "selected";
														} ?>>A</option>
									<option value="2" <?php if ($detail->coscholastic == 2) {
															echo "selected";
														} ?>>B</option>
									<option value="3" <?php if ($detail->coscholastic == 3) {
															echo "selected";
														} ?>>C</option>
								</select>
							</div>
						...
						<div class="col-md-12 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<br>
								<textarea id="oodles_editor5" rows="1" cols="13" name="coscholastic_info"><?php echo $detail->coscholastic_info ?></textarea>
							</div>
						</div>
					...
					<div class="card-body row">
						...
						<div class="col-md-12 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<br>
								<textarea id="oodles_editor6" rows="1" cols="13" name="achievement_info"><?php echo $detail->achievement_info ?></textarea>
							</div>
						</div>
						...
						<div class="col-md-12 col-sm-12">
							<div class=" mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<label> <?php if ((!empty($detail->achievement_images))) { ?>
									...
									<div class="popup" id="modal1">
										<a class="popup__overlay" href="#modal_1"></a>
										<div class="popup__wrapper">
											<a class="popup__close" href="#modal_1">X</a>
					...
					<div class="card-body row">
						...
						<div class="col-md-12 col-sm-12">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<textarea id="oodles_editor7" rows="2" cols="60" name="facility_info"><?php echo $detail->facility_info ?></textarea>
							</div>
						</div>
						<div class="col-md-12 col-sm-12">
							<div class=" mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<label> <?php if ((!empty($detail->facility_images))) { ?>
									...
									<div class="popup" id="modal2">
										<a class="popup__overlay" href="#modal_2"></a>
										<div class="popup__wrapper">
											<a class="popup__close" href="#modal_2">X</a>
					...
					<div class="card-body row">
						...
						<div class="col-md-12 col-sm-12">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<textarea id="oodles_editor8" rows="2" cols="60" name="extra_curricular_info"><?php echo $detail->extra_curricular_info ?></textarea>
							</div>
						</div>
						<div class="col-md-12 col-sm-12">
							<div class=" mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<label> <?php if ((!empty($detail->extra_curricular_images))) { ?>
									...
									<div class="popup" id="modal3">
										<a class="popup__overlay" href="#modal_3"></a>
										<div class="popup__wrapper">
											<a class="popup__close" href="#modal_3">X</a>
					...
					<div class="card-body row">
						...
						<div class="col-md-12 col-sm-12">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<textarea id="oodles_editor9" rows="2" cols="60" name="academic_info"><?php echo $detail->academic_info ?></textarea>
							</div>
						</div>
						<div class="col-md-12 col-sm-12">
							<div class=" mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<label> <?php if ((!empty($detail->academic_images))) { ?>
									...
									<div class="popup" id="modal4">
										<a class="popup__overlay" href="#modal_4"></a>
										<div class="popup__wrapper">
											<a class="popup__close" href="#modal_4">X</a>
					...
					<div class="card-body row">
						...
						<div class="col-md-12 col-sm-12">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<br>
								<textarea id="oodles_editor10" rows="4" cols="60" name="faculty_info"><?php echo $detail->facility_info ?></textarea>
						...
						<div class="col-md-12 col-sm-12">
							<div class=" mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<label> <?php if ((!empty($detail->faculty_images))) { ?>
									...
									<div class="popup" id="modal5">
										<a class="popup__overlay" href="#modal_5"></a>
										<div class="popup__wrapper">
											<a class="popup__close" href="#modal_5">X</a>
				...
				<div class="card-box">
					...
					<div class="card-body row">
						...
						<div class="row form-group multiple-form-group input-group">
							...
							<div class="col-md-3">
								<br>
								<input type="checkbox" name="review_nonacademic" value="1" <?php if ($detail->review_nonacademic == 1) {
																								echo "checked";
																							} ?>>
							...
							<div class="col-md-2">
								<br>
								<input type="checkbox" name="review_school" value="1" <?php if ($detail->review_school == 1) {
																							echo "checked";
																						} ?>>
								<label>School</label>
							</div>
					...
					<div class="card-body row">
						...
						<div class="col-md-12 col-sm-12">
							<div class=" mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<label> <?php if ((!empty($detail->gallery))) { ?>
										Update Multiple Images <a class="" href="#modal6"><i class='fa-solid fa-eye'></i></a>
									<?php } else { ?>
										Insert Multiple Images
									<?php } ?>

									<div class="popup" id="modal6">
										<a class="popup__overlay" href="#modal_6"></a>
										<div class="popup__wrapper">
											<a class="popup__close" href="#modal_6">X</a>
							...
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								<label>Question</label>
									...
									for ($x = 0; $x <= $count_comma; $x++) { ?>
										...
										<input type="text" name="question_faq[]" multiple class="form-control" placeholder="<?php echo $question_faq[$x] ?>" value="<?php echo $question_faq[$x] ?>">
										<span class="input-group-btn"><button type="button" class="btn btn-default btn-remove">-
										</button></span>
									</div>
									<?php } ?>
									<div class="form-group input-group">
									<input type="text" name="question_faq1[]" multiple class="form-control" placeholder="Enter question">
									<span class="input-group-btn"><button type="button" class="btn btn-default btn-add">+
										</button></span>
									</div>
								</div>
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								<label>Answers</label>
									...
									for ($x = 0; $x <= $count_comma; $x++) { ?>
											<div class="form-group input-group">
										<input type="text" name="answer_faq[]" multiple class="form-control" placeholder="<?php echo $answer_faq[$x] ?>" value="<?php echo $answer_faq[$x] ?>">
										<span class="input-group-btn"><button type="button" class="btn btn-default btn-remove">-
										</button></span>
										</div>
									<?php } ?>
									<div class="form-group input-group">
									<input type="text" name="answer_faq1[]" multiple class="form-control" placeholder="Enter answer">
									<span class="input-group-btn"><button type="button" class="btn btn-default btn-add">+
										</button></span>
									</div>
							</div>
					...
					<div class="card-body row">
						...
						<div class="col-md-3 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<input class="form-control mdl-textfield__input" type="text" name="auth_name" placeholder="<?php echo $detail->auth_name ?>" value="<?php echo $detail->auth_name ?>">
							</div>
						</div>
						<div class="col-md-3 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								<label>Designation<span>*</span></label><br>
								<input class="form-control mdl-textfield__input" type="text" name="auth_designation" placeholder="Enter Designation" placeholder="<?php echo $detail->auth_designation ?>" value="<?php echo $detail->auth_designation ?>">
							</div>
						</div>
						...
						<div class="col-md-3 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<input class="form-control mdl-textfield__input" type="number" name="auth_aadhar_no" placeholder="Enter Aadhar Number" placeholder="<?php echo $detail->auth_aadhar_no ?>" value="<?php echo $detail->auth_aadhar_no ?>" oninput="numberOnly(this.id);" maxlength="12">
							</div>
						</div>
						...
						<div class="col-md-3 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<input class="form-control mdl-textfield__input" type="email" id="txtPwd" name="auth_email" placeholder="Enter Email ID" placeholder="<?php echo $detail->auth_email ?>" value="<?php echo $detail->auth_email ?>">
							</div>
						</div>
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<input class="form-control mdl-textfield__input" type="number" name="auth_contact_number" placeholder="Enter Contact Number" placeholder="<?php echo $detail->auth_contact_number ?>" value="<?php echo $detail->auth_contact_number ?>" oninput="numberOnly(this.id);" maxlength="10">
							</div>
						</div>
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<input class="form-control mdl-textfield__input" type="text" name="auth_contact_person" placeholder="Enter First Contact Person Name" placeholder="<?php echo $detail->auth_contact_person ?>" value="<?php echo $detail->auth_contact_person ?>">
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<input class="form-control mdl-textfield__input" type="text" name="contact_person_designation" placeholder="Enter Contact Person Designation" placeholder="<?php echo $detail->contact_person_designation ?>" value="<?php echo $detail->contact_person_designation ?>">
							</div>
						</div>
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<input class="form-control mdl-textfield__input" type="number" name="contact_person_details" placeholder="Contact Person Details" placeholder="<?php echo $detail->contact_person_details ?>" value="<?php echo $detail->contact_person_details ?>">
							</div>
						</div>
					...
					<?php if (!empty($detail->signatory_aadhar)) { ?>
						...
						<div class="col-md-6 col-sm-6">
							...
							<?php if (!empty($detail->auth_image)) { ?>
									<label>Update Image Copy of Authorized Signatory<span>*</span></label>
									<a href="<?php echo URLROOT ?>/uploads/<?php echo $detail->auth_image ?>" id="blah" target="_blank"><i class='fa-solid fa-eye'></i></a><br>
								<?php } else { ?>
									<label>Upload Image Copy of Authorized Signatory<span>*</span></label><br>
								<?php } ?>
					...
					<div class="col-md-4 col-sm-6">
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<input class="form-control mdl-textfield__input" type="text" name="school_name_as_per_bank" id="" placeholder="<?php echo $detail->school_name_as_per_bank ?>" value="<?php echo $detail->school_name_as_per_bank ?>">
							</div>
						</div>
						<div class="col-md-6 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					...
					<div class="card-body row">
						...
						<div class="col-md-12 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<br>
								<textarea id="oodles_editor11" rows="4" cols="100" name="package_info"><?php echo $detail->package_info?></textarea>
							</div>
						</div>
