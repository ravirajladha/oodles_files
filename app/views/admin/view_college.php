...
<?php $detail = $data['get_college_detail'] ?>
					...
					<div class="card-body row">
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<select name="mode_of_admission" class="form-control" required>
					...
					<div class="card-body row">
						...
						<div class="col-md-3 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<input class="form-control mdl-textfield__input" type="text" name="auth_signature" placeholder="<?php echo $detail->auth_signature ?>" value="<?php echo $detail->auth_signature ?>">
							</div>
						</div>
						<div class="col-md-3 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
						...
						<div class="col-md-3 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<input class="form-control mdl-textfield__input" type="email" id="txtPwd" name="auth_email" placeholder="<?php echo $detail->auth_email ?>" value="<?php echo $detail->auth_email ?>">
							</div>
						</div>
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<input class="form-control mdl-textfield__input" id="auth_contact_number" type="number" name="auth_contact_number" placeholder="<?php echo $detail->auth_contact_number ?>" value="<?php echo $detail->auth_contact_number ?>" oninput="numberOnly(this.id);" maxlength="10">
							</div>
						</div>
