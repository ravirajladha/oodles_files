...
<div class="thumb-center" style="margin-top:10px;background-color:yellow;vertical-align:center;">
  ...
  <?php if ($today < $startdate) { echo "until start"; } else { echo "to end"; } ?>
											...
											<div class="course-box">
												...
												<a href="<?php echo URLROOT; ?>/admin/scholarship/<?php echo $scholarship->id; ?>">
													<h6 style="text-align:center;"><b><u><?php echo strtoupper($trimstring) ?></u></b></h6>
												</a>
												<a href="<?php echo URLROOT; ?>/admin/scholarship_application/<?php echo $scholarship->id; ?>" style="color:green;" target="_blank">
													<h6 style="text-align:center;"><b>VIEW SCHOLARSHIP APPLICANTS</b></h6>
												</a>
												...
												<tbody>
													<?php foreach ($data['get_all_scholarship'] as $scholarship) { ?>
														...
														<tr class="odd gradeX">
															...
															<td class="left"> <a href="<?php echo URLROOT; ?>/admin/scholarship/<?php echo $scholarship->id; ?>" style="color:green;" target="_blank"><?php echo ucwords($scholarship->name); ?></a></td>
															<td>
																<?php
															...
															<td class="left"><?php echo date('d-m-Y', strtotime($scholarship->start_date)); ?></td>

															<!-- <td class="left"><?php echo $scholarship->end_date; ?></td> -->
															<td class="left"><?php echo date('d-m-Y', strtotime($scholarship->end_date)); ?></td>
															<?php if ($_SESSION['rexkod_oodles_login_type'] == 'admin') { ?>
																<?php if ($scholarship->status == 0) { ?>
																	<td><a href="<?php echo URLROOT; ?>/admin/update_scholarship_status2/<?php echo $scholarship->id ?>/1"> <button type="button" class="btn blue-bgcolor btn-outline m-b-10">Active</button></a></td>

																<?php } else { ?>
																	<td><a href="<?php echo URLROOT; ?>/admin/update_scholarship_status2/<?php echo $scholarship->id ?>/0"> <button type="button" class="btn deepPink btn-outline m-b-10">
																				Inactive</button> </a></td>
																<?php } ?>
															<?php } ?>

															<?php if ($scholarship->featured == 0) { ?>

																<td><a href="<?php echo URLROOT; ?>/admin/update_scholarship_featured/<?php echo $scholarship->id ?>/1"> <button type="button" class="btn blue-bgcolor btn-outline m-b-10">Featured</button></a></td>

															<?php } else { ?>
																<td><a href="<?php echo URLROOT; ?>/admin/update_scholarship_featured/<?php echo $scholarship->id ?>/0"><button type="button" class="btn deepPink btn-outline m-b-10">UnFeatured</button> </a></td>
															<?php } ?>
														...
														<td class="left">22 Feb 2000</td> -->
															<td>
																<a href="<?php echo URLROOT; ?>/admin/scholarship_application/<?php echo $scholarship->id; ?>" class="tblEditBtn">
																	<i class="fa fa-eye"></i>
																</a>
															</td>
															<td>
																<?php $get_selected_scholarship_application = $adminMod->get_selected_scholarship_application($scholarship->id);
																echo count($get_selected_scholarship_application); ?>
															</td>

															<td>
																
															<a href="<?php echo URLROOT; ?>/admin/shortlisted_students/<?php echo $scholarship->id; ?>" class="tblEditBtn">
																	<i class="fa fa-eye"></i>
																</a>
															...
															<a href="<?php echo URLROOT; ?>/admin/scholarship_report/<?php echo $scholarship->id; ?>" class="tblEditBtn">
															...
															<?php if ($_SESSION['rexkod_oodles_login_type'] == 'admin') { ?>
																<td>
																	<a href="<?php echo URLROOT; ?>/admin/edit_scholarship/<?php echo $scholarship->id; ?>" class="tblEditBtn">
