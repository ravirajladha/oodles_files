		...
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				<div class=" pull-left">
					...
					<div class="page-title">Add Criteria</div>
				</div>
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card-box">
					...
					<form method="post" action="<?php echo URLROOT; ?>/admin/create_criteria" enctype="multipart/form-data">
						<div class="card-body row">
							...
							<div class="col-lg-6 p-t-20">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
									<input class="mdl-textfield__input" type="text" id="txtTimeLength" name="criteria_name" required>
							...
							<div class="col-lg-12 p-t-20">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									...
									<select name="criteria_type" class="form-control" id="dbType">
										...
										<option value="3">Range Based</option>
									</select>
								</div>
							</div>
...
<!-- 
																	...
																	<td>
																	<?php if (!empty($criteria->yes_no_based)) { ?>
																		<?php echo $criteria->yes_no_based ?>
																	<?php }?>
																	</td>
																	<td>
																	<?php if (!empty($criteria->start_date)) { ?>
																		<?php echo $criteria->start_date ?>
																	<?php }?>
																	</td>
																	<td>
																	<?php if (!empty($criteria->end_date)) { ?>
																		<?php echo $criteria->end_date ?>
																	<?php }?>
																	</td>
																	<td>
																	<?php if (!empty($criteria->start_range)) { ?>
																		<?php echo $criteria->start_range ?>
																	<?php }?>
																	</td>
																	<td>
																	<?php if (!empty($criteria->end_range)) { ?>
																		<?php echo $criteria->end_range ?>
																	<?php }?>
																	</td>
																	...
																	<?php if ($criteria->status == 0) {?>
																		...
																		<td><a href="<?php echo URLROOT; ?>/admin/update_criteria_status/<?php echo $criteria->id ?>/1"><button type="button" class="btn btn-warning">Active</button></a></td>
																	
																	<?php } else{?>
																		<td><a href="<?php echo URLROOT; ?>/admin/update_criteria_status/<?php echo $criteria->id ?>/0"><button type="button" class="btn btn-warning">Inactive</button></a></td>
																	<?php }?>
																	
																	<td>
																		<a href="<?php echo URLROOT; ?>/admin/edit_criteria/<?php echo $criteria->id ?>" class="tblEditBtn">
