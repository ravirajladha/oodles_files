	...
	<div class="page-content">
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				<div class=" pull-left">
					<div class="page-title">Add School Plan</div>
				</div>
		...
		<div class="row">
			<div class=" col-sm-12">
				<div class="card-box">
					...
					<form method="post" action="<?php echo URLROOT; ?>/admin/create_subscription_plans_for_school" enctype="multipart/form-data" autocomplete="OFF">
							...
							<div class="card-body row">
								...
								<div class="col-md-3 col-sm-3">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<input type="number" id="no_of_teacher" name="no_of_teacher" class="form-control mdl-textfield__input" placeholder="Enter Number of Teacher" required>
									</div>
								</div>
								<div class="col-md-3 col-sm-3">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Enter Number of Quiz</label>
										<input type="number" id="offer_price" name="no_of_quiz" class="form-control mdl-textfield__input" placeholder="Enter Number of Quiz" required>
									</div>
								</div>
									...
									<div class="card card-box">
										...
										<div class="card-body ">
											...
											<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
												...
												<tbody>
													<?php foreach ($data['get_school_plan'] as $subscription) { ?>
														<tr class="odd gradeX">
															...
															<td class="left"><?php echo $subscription->no_of_teacher?></td>

															<td class="left"><?php echo $subscription->no_of_quiz?></td>
															<td class="left"><?php if($subscription->status==1){echo "Active";}else{echo "Inactive";}?></td>

															<td>
																<a href="<?php echo URLROOT?>/admin/edit_plans_for_school/<?php echo $subscription->id;?>" class="tblEditBtn">
