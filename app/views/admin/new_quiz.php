						...
						<div class="card-body row">
							...
							<div class="col-md-12 col-sm-12">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									<?php foreach ($get_all_question as $question) { ?>
										<label>
											<?php echo $question->question; ?>
										</label>
										<a href="<?php echo URLROOT ?>/admin/add_question_to_quiz/<?php echo $question->id ?>/<?php echo $page_path; ?>" style="float:right;"><i class="fa-solid fa-check"></i>
									</a>
									<br>
									<?php } ?>
								</div>
							...
							<div class="col-md-12 col-sm-12">
								<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
									<label>
										...
										?></label>
										<a href="<?php echo URLROOT ?>/admin/delete_question_from_quiz/<?php echo $get_question_name->id ?>/<?php echo $page_path; ?>" style="float:right;"><i class="fa-solid fa-trash-can"></i></a><br>
							<?php }
										}
							?>
								</div>
