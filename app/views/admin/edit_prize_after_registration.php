        ...
        <div class="row mt-5">
            <div class=" col-sm-12">
                <div class="card-box">
                    ...
                    <form method="POST" action="<?php echo URLROOT; ?>/admin/final_prize_amount_store/<?php echo $get_quiz_detail->id ?>" enctype="multipart/form-data" autocomplete="OFF">

                        <div class="card-body row">

                            <div class="mb-3 col-lg-6 col-sm-12">
                                <label for="" class="form-label">No. of Participants</label>
                                <input type="number" name="no_of_participants" value="<?php echo $count_of_quiz_registration ?>" class="form-control" id="input1" placeholder="Enter No. of Participants" readonly>
                            </div>
                            <div class="mb-3 col-lg-6 col-sm-12">
                                <label for="" class="form-label">Entry Fee</label>
                                <input type="number" name="entry_fee" value="<?php echo $prize_pool_calculation->entry_fee ?>" class="form-control" id="input2" placeholder="Enter Entry Fee" step="any" readonly>
                            </div>
                            <div class="mb-3 col-lg-6 col-sm-12">
                                <label for="" class="form-label">Total Amount collected</label>
                                <input type="number" name="total_amount_collected" value="<?php echo $get_amount_registered_for_quiz ?>" class="form-control" id="input3" readonly>
                            </div>
                            <div class="mb-3 col-lg-6 col-sm-12">
                                <label for="" class="form-label">Expenses in %</label>
                                <input type="number" name="expenses" value="<?php echo $prize_pool_calculation->expenses ?>"  class="form-control" id="input4" placeholder="Enter Expenses in %" step="any" readonly>
                            </div>

                            <div class="mb-3 col-lg-6 col-sm-12">
                                <label for="" class="form-label">Total Expenses</label>
                                <?php $total_expenses= ($get_amount_registered_for_quiz* $prize_pool_calculation->expenses)/100; ?>
                                <input type="number" name="total_expenses" value="<?php echo $total_expenses ?>" class="form-control" id="input5" readonly>
                            </div>
                            <div class="mb-3 col-lg-6 col-sm-12">
                                <label for="" class="form-label">Prize Pool Amount [ Amount to disburse as prize ]</label>
                                <?php $amount_to_disburse= $get_amount_registered_for_quiz - $total_expenses; ?>
                                <input type="number" name="prize_pool_amount" value="<?php echo $amount_to_disburse ?>"  class="form-control" id="input8" readonly>
                            </div>
                            <div class="mb-3 col-lg-6 col-sm-12">
                                <label for="" class="form-label">Number of Winners %</label>
                                <input type="number" name="no_of_winners_percentage" value="<?php echo $prize_pool_calculation->no_of_winners_percentage ?>" class="form-control" id="input6" placeholder="Enter" step="any" readonly>
                            </div>

                            <div class="mb-3 col-lg-6 col-sm-12">
                                <label for="" class="form-label">Total Number of Winners</label>
                                <?php $total_no_of_winners = intval(($count_of_quiz_registration * $prize_pool_calculation->no_of_winners_percentage)/100 );
                                if($total_no_of_winners ==0){
                                    $total_no_of_winners =1;
                                }
                                ?>
                                <input type="number" name="total_no_of_winners" value="<?php echo $total_no_of_winners ?>" class="form-control" id="input7" readonly>
                            </div>
                            ...
                            <div class="mt-5">
                                ...
                                <button type="submit" class="btn btn-success" style="float: left;" id="submit">Submit</button>  <a id="add_row" class="btn btn-default pull-right">Add Row</a>
