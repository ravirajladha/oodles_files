		...
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				...
				<ol class="breadcrumb page-breadcrumb pull-right">
					...
					<li><a class="parent-item" href="<?php echo URLROOT; ?>/admin/quizes/4/0">Quizes</a>&nbsp;<i class="fa fa-angle-right"></i>
					</li>
				...
				<div class="panel tab-border card-box">
					<header class="panel-heading panel-heading-gray custom-tab ">
						<ul class="nav nav-tabs">
							...
							<li class="nav-item"><a href="#contact"  class="active"  data-bs-toggle="tab">Contest</a>
							</li>
										...
										<?php foreach ($quiz_practice as $quiz) { ?>
											<tr class="odd gradeX">
												...
												<td class="left">
													...
													<?php } ?></td>
												<td class="left"><?php
												$get_admin_detail= $adminMod->get_auth_detail($quiz->created_by);
												 echo $get_admin_detail->name ?></td>
...
?>
												...
												<td><a href="<?php echo URLROOT; ?>/admin/quiz_contest_report/<?php echo $quiz->id; ?>" target="_blank">View</a></td>
											</tr>
										<?php } ?>
