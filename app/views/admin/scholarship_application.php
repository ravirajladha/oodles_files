...
<form method="get" action="/scholarship/search">
										...
										<h5> Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati, aliquid!</h5>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4 col-md-4  col-sm-4">
                                                                    <a href="<?php echo URLROOT; ?>/admin/scholarship_status/<?php echo $scholarship_app->id; ?>">
                                                ...
                                                <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="<?php echo URLROOT; ?>/admin/update_scholarship_status_for_student/<?php echo $scholarship_app->scholarship_id; ?>" method="post">
