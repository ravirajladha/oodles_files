	...
	<div class="page-content">
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				<div class=" pull-left">
					<div class="page-title">Add Faq</div>
				</div>
		...
		<div class="row">
			<div class=" col-sm-12">
				<div class="card-box">
					...
					<form method="post" action="<?php echo URLROOT; ?>/admin/create_faq" enctype="multipart/form-data" autocomplete="OFF">
							...
							<div class="card-body row">
								...
								<div class="col-md-12 col-sm-12">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<input type="text" id="name" name="question" class="form-control mdl-textfield__input" placeholder="Enter Question" required>
								...
								<div class="col-md-12 col-sm-12">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<label>Answer</label>
										<input type="text" id="price" name="answer" class="form-control mdl-textfield__input" placeholder="Enter Answer">
									</div>
								</div>
		...
		<?php $count = 0;
		foreach($data['get_all_faqs'] as $faq){
			$count++;
			 ?>
		...
		<tr>
			...
			<td class="left">
																<?php if($faq->status==0){ ?>
															<a href="<?php echo URLROOT ?>/admin/update_faq_status/<?php echo $faq->id;?>/1"><button class="btn btn-primary">Approve</button></a>
														<?php }else{ ?>
															<a href="<?php echo URLROOT ?>/admin/update_faq_status/<?php echo $faq->id;?>/0"><button class="btn btn-warning">Disapprove</button></a>
														<?php } ?>
														</td>
			<td class="left">
			<a href="<?php echo URLROOT ?>/admin/edit_faq/<?php echo $faq->id;?>"><i class="fa fa-pencil fa-fw"></i>
														</td>
		</tr>
		<?php } ?>
		</table>
