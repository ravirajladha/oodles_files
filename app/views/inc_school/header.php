...
<body
	...
	<div class="page-wrapper">
					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown dropdown-user">
							<a class="dropdown-toggle" data-bs-toggle="dropdown" data-hover="dropdown"
								...
								<span class="username username-hide-on-mobile"> School
							</a>
							<ul class="dropdown-menu dropdown-menu-default">
								...
								<li>
									<a href="<?php echo URLROOT; ?>/school/logout">
		...
		<div class="page-container">
			<!-- start sidebar menu -->
			<?php if(isset($_SESSION['rexkod_oodles_school_id'])){ ?>
				...
				<div class="sidemenu-container navbar-collapse collapse fixed-menu">
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="sidebar-user-panel">
								<div class="sidebar-user">
									...
									<div class="sidebar-user-details">
										<div class="user-name"><?php echo $_SESSION['rexkod_oodles_school_name']?></div>
										<div class="user-role">School</div>
									</div>
								</div>
							</li>
							...
							<li class="nav-item ">
							<!-- <?php if($_SESSION['nav']=="scholarship"){ echo "start active open"; } ?> -->
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="<?php echo URLROOT; ?>/school/teacher" class="nav-link "> <span class="title">All
										Teachers</span>
										</a>
									</li>
									<li class="nav-item">
										<a href="<?php echo URLROOT; ?>/school/add_teacher" class="nav-link "> <span class="title">Add
										Teachers</span>
										</a>
									</li>
									
									<!-- <li class="nav-item">
										<a href="<?php echo URLROOT; ?>/corporate/scholarship_application" class="nav-link "> <span class="title">
							...
							<!-- <?php if($_SESSION['nav']=="scholarship"){ echo "start active open"; } ?> -->
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="<?php echo URLROOT; ?>/school/students" class="nav-link "> <span class="title">All
										Students</span>
										</a>
									</li>
							...
							<!-- <?php if($_SESSION['nav']=="scholarship"){ echo "start active open"; } ?> -->
								<a href="#" class="nav-link nav-toggle"> <i data-feather="book"></i>
									<span class="title">Wallet</span> <span class="arrow"></span>
									
								</a>
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="<?php echo URLROOT; ?>/school/wallet" class="nav-link "> <span class="title">All
										Wallet</span>
										</a>
									</li>
							...
							<!-- <?php if($_SESSION['nav']=="scholarship"){ echo "start active open"; } ?> -->
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="<?php echo URLROOT; ?>/school/my_subscription" class="nav-link "> <span class="title">My Subscription</span>
										</a>
									</li>
							...
							<!-- <?php if($_SESSION['nav']=="scholarship"){ echo "start active open"; } ?> -->
								<a href="#" class="nav-link nav-toggle"> <i data-feather="book"></i>
									<span class="title">Quizes</span> <span class="arrow"></span>
									
								</a>
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="<?php echo URLROOT; ?>/school/quizes/1/0" class="nav-link "> <span class="title">All
										Quizes</span>
										</a>
									</li>
									<li class="nav-item">
										<a href="<?php echo URLROOT; ?>/school/quiz_master" class="nav-link "> <span class="title">Quiz Master</span>
										</a>
									</li>
									<li class="nav-item">
										<a href="<?php echo URLROOT; ?>/school/quiz_result" class="nav-link "> <span class="title">Quiz Results</span>
										</a>
									</li>
									<li class="nav-item">
										<a href="<?php echo URLROOT; ?>/school/resources" class="nav-link "> <span class="title">Resources</span>
										</a>
									</li>
