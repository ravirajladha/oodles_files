            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 bhoechie-tab">
								...
								<span class="info-box-icon push-bottom"><i class="fa fa-question" ></i></span>
									<div class="info-box-content">
									 ...
									 <?php 
											...
											$get_wallet_detail->quiz_balance;
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="white-box border-gray">
								<div class="user-bg">
									...
									<form method="post" action="<?php echo URLROOT; ?>/college/pay" enctype="multipart/form-data" autocomplete="OFF">
				...
				<div>
							<div>
								...
								<a href="<?php echo URLROOT?>/college/buy_quiz_for_college">
								<div class="card-body">
									<div class="row">
