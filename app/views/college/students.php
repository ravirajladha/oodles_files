												...
												<div class="card card-box">
													<div class="card-head">
														...
														<header>All Students List</header>
															...
															<div class="row">	
															<div class="col-md-8">
            <input class="form-control text-center" type="text" placeholder="Search Name" 
             name="search_input">
</div>
<div class="col-md-4">
             <button type="submit" class="btn btn-primary"><i class="fas fa-filter"></i>&nbsp;Filter</button>
													...
													<div class="card-body ">
														...
														<i class="fa fa-graduation-cap"></i>
																	...
																	<td class="left"><?php echo $student->student_id ?></td>
																
																	<?php $schoolMod = New Schools;
	$get_student_detail = $schoolMod->get_student_detail($student->student_id);
																	?>
																		<td>
																
																<?php echo $get_student_detail->name?>
																																	</td>
																	<td class="left"><?php echo $get_student_detail->email ?></td>
																	<td><a href="#">
																	<?php echo $get_student_detail->phone ?> </a></td>
													...
													<div class="card-body no-padding ">
														...
														<div class="doctor-profile">
															...
															<div class="profile-usertitle">
																<div class="doctor-name"><?php echo $student->student_id ?>  </div>
																<div class="name-center"> <?php echo $get_student_detail->email ?> </div>
															</div>
														
															<div>
																<p><i class="fa fa-phone"></i><a
																		href="tel:<?php echo $get_student_detail->phone ?>"><?php echo $get_student_detail->phone ?></a></p>
															</div>
