...
<div class="page-wraper">
    ...
    <div class="page-content">
        ...
        <div class="container" style="margin-top:25px">
            ...
            <form class="multisteps_form" id="wizard" method="POST" action="<?php echo URLROOT?>/distributor/user_register">
                    <div class="input-group">
                        <input type="text" placeholder=" Name" class="form-control" name="name">
                    </div>
                    <!-- make email id as optional -->
                    <div class="input-group">
                        <input type="email" placeholder=" Email" class="form-control" name="email">
                    </div>
                    <div class="input-group">
                        <input type="number" placeholder=" Mobile No" class="form-control" name="phno" id="phone_otp" onkeyup="checkphn(this.value);">
                    </div>
