...
<body>
	<!-- modal start -->
	<div class="modal show" id="myModal" tabindex="-1" role="dialog" aria-hidden="true" style="left: -6px;" data-bs-backdrop="static" data-bs-keyboard="false">
		<div class="modal-dialog modal-dialog-centered modal-xl myModal modal-dialog-scrollable" role="document" >
			<div class="modal-content modal-popout-bg">
				...
				<div class="modal-body">
					<div class="signup-image col-md-12 col-sm-12" style=" border: 1px solid black;">
						...
						<h6 class="" style="text-align: center;">Welcome to the OodlesIN !</h6>
						<!-- <div class="signin-form col-md-6 scrollit"> -->
						
						<table style="justify-content: center;">
							<tr>
								<td >I/we hereby grant permission for my/our child to use the
							...
							<tr>
								<td >I/we declare that all demographic and personal information
							...
							<tr>
								<td >I grant OodlesIN permission to use the information provided,
			...
			<div class="container">
				<div class="signup-content row">
					<div class="signup-form col-md-5">
						...
						<form method="post" action="<?php echo URLROOT; ?>/student/student_register_mobile" autocomplete="off" class="register-form">
...
?>
							...
							<!-- <div class="form-group">
								...
								<label for="agree-term" class="label-agree-term" style="font-size:15px"> By clicking on submit, you agree to all the <a href="#" class="term-service">Terms and Conditions*.</a></label>
							</div> -->
							...
							<div class="form-group form-button d-flex justify-content-between">
								...
								<!-- <div class="d-flex">
								<p style="font-size:12px; margin-right:10px;">Don't Have Account </p>
								<a href="<?php echo URLROOT; ?>/student/login" class="signup-image-link btn btn-warning" style="background-color:#F99300;">Sign In</a>
								</div> -->
							</div>
						</form>
