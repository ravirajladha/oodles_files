...
<div class="page-content-wrapper">
	...
	<div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style=" width: <?php echo $percentage_filled_column; ?>%">Profile Completed: <?php echo round($percentage_filled_column); ?>%</div>
		...
		<form method="post" action="<?php echo URLROOT; ?>/student/update_profile_data/<?php echo $_SESSION['rexkod_oodles_student_id'] ?>" enctype="multipart/form-data" autocomplete="OFF" id="form">
						...
						<div class="card card-box">
							...
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-md-1 col-sm-6 mobile-check" style="display:none;">
									...
									<div class="col-md-1 col-sm-6 web-check">
										<br>
										<br>
						...
						<div class="card card-box">
							<div class="card-head">
								...
								<!-- <i class="fa-solid fa-circle-info"></i> -->
									<i class="fa-solid fa-circle-info" style= "display:none;" id="current_academic_icon"></i>
									<a class="fa fa-repeat btn-color box-refresh" href="javascript:;"></a>
									<a class="t-collapser btn-color fa fa-chevron-down" href="javascript:;"></a>
									<a class="t-close btn-color fa fa-times" href="javascript:;"></a>
								</div>
					...
					<div class="col-md-12">
						<div class="card card-box">
							<div class="card-head">
								...
								<div class="tools">
									<i class="fa-solid fa-circle-info" style= "display:none;" id="previous_academic_icon"></i>
									<a class="fa fa-repeat btn-color box-refresh" href="javascript:;"></a>
									<a class="t-collapser btn-color fa fa-chevron-down" href="javascript:;"></a>
									<a class="t-close btn-color fa fa-times" href="javascript:;"></a>
								</div>
					...
					<div class="col-md-12">
						<div class="card card-box">
							<div class="card-head">
								...
								<div class="tools">
								<i class="fa-solid fa-circle-info" style= "display:none;" id="family_information_icon"></i>
									<a class="fa fa-repeat btn-color box-refresh" href="javascript:;"></a>
									<a class="t-collapser btn-color fa fa-chevron-down" href="javascript:;"></a>
									<a class="t-close btn-color fa fa-times" href="javascript:;"></a>
								</div>
					...
					<div class="col-md-12">
						<div class="card card-box">
							<div class="card-head">
								...
								<div class="tools">
								<i class="fa-solid fa-circle-info" style= "display:none;" id="communication_address_icon"></i>
									<a class="fa fa-repeat btn-color box-refresh" href="javascript:;"></a>
									<a class="t-collapser btn-color fa fa-chevron-down" href="javascript:;"></a>
									<a class="t-close btn-color fa fa-times" href="javascript:;"></a>
								</div>
					...
					<div class="col-md-12">
						<div class="card card-box">
							<div class="card-head">
								...
								<div class="tools">
								<i class="fa-solid fa-circle-info" style= "display:none;" id="bank_details_icon"></i>
									<a class="fa fa-repeat btn-color box-refresh" href="javascript:;"></a>
									<a class="t-collapser btn-color fa fa-chevron-down" href="javascript:;"></a>
									<a class="t-close btn-color fa fa-times" href="javascript:;"></a>
								</div>
								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-6">
										<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											...
											<input type="text" id="ifsc_code" name="ifsc_code" class="form-control mdl-textfield__input" <?php if(!empty($student->ifsc_code)){ ?>placeholder="<?php echo $student->ifsc_code ?>" <?php }else{ ?> placeholder="Enter IFSC Code" <?php } ?> oninput="numberOnly(this.id);" maxlength="11" value="<?php echo $student->ifsc_code ?>">
										</div>
									</div>
									<div class="col-md-6 col-sm-6">
										<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					...
					<div class="col-md-12">
						<div class="card card-box">
							<div class="card-head">
								...
								<div class="tools">
									<i class="fa-solid fa-circle-info" style= "display:none;" id="about_you_icon"></i>
									<a class="fa fa-repeat btn-color box-refresh" href="javascript:;"></a>
									<a class="t-collapser btn-color fa fa-chevron-down" href="javascript:;"></a>
									<a class="t-close btn-color fa fa-times" href="javascript:;"></a>
								</div>
...
<script>
	...
	$(document).ready(function() {
		...
		<?php 
if (!empty($student)) {
    if ($student->institute_city == null || $student->academic_type == null || $student->academic_name == null || $student->institute_state == null || $student->course == null || $student->board == null) {?>
		var icon = document.getElementById("current_academic_icon");
		icon.style.display="inline-block";
		icon.style.color="red";
	<?php }
	if ($student->p_academic_name == null || $student->p_class == null || $student->p_cgpa == null || $student->p_start_date == null || $student->p_end_date == null || $student->board == null) {?>
		var icon = document.getElementById("previous_academic_icon");
		icon.style.display="inline-block";
		icon.style.color="red";
	<?php }
	if ($student->siblings == null || $student->annual_income == null || $student->father_name == null || $student->f_aadhar == null || $student->f_phone == null || $student->f_email_id == null || $student->father_aadhar_doc == null || $student->mother_name == null || $student->m_aadhar == null || $student->m_phone == null || $student->m_email_id == null || $student->mother_aadhar_doc == null ) {?>
		var icon = document.getElementById("family_information_icon");
		icon.style.display="inline-block";
		icon.style.color="red";
	<?php }
	if ($student->comm_address == null || $student->comm_pin_code == null || $student->comm_village == null || $student->comm_block == null || $student->comm_state == null || $student->perm_address == null || $student->perm_pin_code == null || $student->perm_village == null || $student->perm_block == null || $student->perm_state == null) {?>
		var icon = document.getElementById("communication_address_icon");
		icon.style.display="inline-block";
		icon.style.color="red";
	<?php }
	if ($student->bank_name == null || $student->bank_branch == null || $student->ifsc_code == null || $student->passbook_statement == null || $student->account_no == null || $student->re_account_no == null || $student->name_as_per_bank == null) {?>
		var icon = document.getElementById("bank_details_icon");
		icon.style.display="inline-block";
		icon.style.color="red";
	<?php }
	if ($student->description == null || $student->hobby == null || $student->achievements == null || $student->mother_tongue == null) {?>
		var icon = document.getElementById("about_you_icon");
		icon.style.display="inline-block";
		icon.style.color="red";
	<?php }?>
