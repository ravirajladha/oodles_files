                            ...
                            <table class="table table-bordered border-dark table-hover" id="tab_logic">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                                ...
                                                <tr <?php if ($_SESSION['rexkod_oodles_student_id'] == $quiz_result->user_id) { ?> style="background-color:#F0E68C;" <?php } ?>>
                                                    <?php if ($count <= count($get_quiz_scores)) { ?>

                                                        <td class="text-center"><?php echo $count; ?></td>
                                                        <td class="text-center"><?php echo $individual_amount_int; ?></td>
                                                    <?php } ?>
                                                    <?php if ($count <= count($get_quiz_scores)) { ?>
