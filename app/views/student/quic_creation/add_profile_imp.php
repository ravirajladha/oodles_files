							...
							<div class="row">
								...
								<div class="col-md-4 col-sm-6">
									...
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<input type="text" class="form-control mdl-textfield__input" id="f_name" name="f_name" placeholder="Enter First Name" required>
									</div>
								</div>
						...
						<div class="col-md-6 col-sm-6">
								...
								<div class="col-md-6 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<input type="number" class="form-control mdl-textfield__input" name="comm_pin_code" id="comm_pin_code" onkeyup="find_pincode_c(this.value)"  placeholder="Enter Pin Code" oninput="numberOnly(this.id);" maxlength="6" minlength="6" required >
									</div>
								</div>
								<div class="col-md-4 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                            ...
                            <option disabled hidden>...................................</option>
								...
								<div class="col-md-4 col-sm-6">
									<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										...
										<input type="text" class="form-control mdl-textfield__input" name="comm_block" id="comm_block" value=" " readonly placeholder="Enter Block/Taluk/Town"  required>
					...
					<div class="card-body row">
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<input type="text" id="ifsc_code" name="ifsc_code" class="form-control mdl-textfield__input" placeholder="Enter IFSC Code"  oninput="numberOnly(this.id);" maxlength="11"  required>
							</div>
						</div>
						...
						<div class="col-lg-6 col-sm-6">
							...
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<input type="number" name="account_no" id="account_no" class="form-control mdl-textfield__input" placeholder="Enter Bank Account Number" oninput="numberOnly(this.id);" maxlength="18" required >
							</div>
						</div>
						<div class="col-md-6 col-sm-6">
							<!-- text input -->
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								<label>Re-enter Savings Bank Account Number<span>*</span></label><span>&nbsp;</span><span id='message'></span>
								<input type="number" name="re_account_no" id="re_account_no" class="form-control mdl-textfield__input" placeholder="Re-Enter Bank Account Number"  oninput="numberOnly(this.id);" maxlength="18" required>
						...
						<div class="col-md-12 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								<label>Enter name as per Passbook<span>*</span></label>
								<input type="text" id="name_as_per_bank" name="name_as_per_bank" class="form-control mdl-textfield__input" placeholder="Enter name as per Passbook"  required>
							</div>
						</div>
					...
					<div class="card-body row">
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								...
								<input type="number" class="form-control mdl-textfield__input" name="annual_income" id="annual_income" placeholder="Enter Annual Income" oninput="numberOnly(this.id);" maxlength="12" required>
							</div>
						</div>
						<div class="">
						...
						<div class="col-md-3 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								<label>Aadhar Number<span>*</span></label>
								<input type="number" id="f_aadhar" name="f_aadhar" class="form-control mdl-textfield__input" placeholder="XXXXXXXXXXXX" oninput="numberOnly(this.id);" maxlength="12" required>
							</div>
						</div>
						...
						<div class="col-md-3 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								<label>Mobile Number<span>*</span></label>
								<input type="number" id="f_phone" name="f_phone" class="form-control mdl-textfield__input" oninput="numberOnly(this.id);" maxlength="10" placeholder="Enter Mobile Number"  required>
							</div>
						</div>
						<div class="col-md-3  col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
						...
						<div class="col-md-3 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								<label> Aadhar Number<span>*</span></label>
								<input type="number" id="m_aadhar" name="m_aadhar" class="form-control mdl-textfield__input" oninput="numberOnly(this.id);" maxlength="12" placeholder="XXXXXXXXXXXX"  required>
							</div>
						</div>
						...
						<div class="col-md-3 col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
								<label>Mobile Number<span>*</span></label>
								<input type="number" id="m_phone" name="m_phone" class="form-control mdl-textfield__input" oninput="numberOnly(this.id);" maxlength="10" placeholder="Enter Mobile Number" required >
							</div>
						</div>
						<div class="col-md-3  col-sm-6">
							<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
				...
				<div class="card-box">
					...
					<div class="card-body row">
						<!-- <div class="card-body" id="bar-parent2">
										...
										<div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											...
											<select name="school" class="action form-control" disabled>
												<?php foreach ($data['get_school_detail'] as $school_detail) { ?>
													<option value="<?php echo $school_detail->id; ?>"><?php echo $school_detail->college_name; ?></option>
												<?php } ?>
							...
							<!-- id="school_college_div"  style="display:none;" -->
